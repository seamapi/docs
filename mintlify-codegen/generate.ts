...
/**
 * Canonicalize `docs.seam.co` links in the generated output (openapi.json +
 * the API `object.mdx` pages). These links originate in `@seamapi/types`
 * descriptions. For each link this:
 ...
 */
async function canonicalizeGeneratedLinks(docsDir: string): Promise<number> {
...
async function loadRedirectMap(docsDir: string): Promise<Map<string, string>> {
