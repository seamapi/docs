...
# puts seam.thermostats.list(manufacturer: "nest").inspect
...
# action_attempt = seam.thermostats.off(
#   device_id: living_room_thermostat.device_id
# )
...
# puts updated_living_room_thermostat.inspect

# schedules = seam.thermostats.schedules.list(
#   device_id: updated_living_room_thermostat.device_id
# )

# puts schedules.inspect

# puts seam.devices.list(manufacturer: "nest").inspect

# puts seam.devices.list(manufacturer: "honeywell_resideo").inspect

# lock1 = seam.devices.get(device_id: "d87eea5d-71c6-4633-a966-396c5ac51177")
# lock2 = seam.devices.get(device_id: "5636ce11-b11f-4a1f-acd3-ae5c2856173c")

# puts seam.access_codes.create(
#   device_id: lock.device_id,
#   name: "my access code",
#   code: "1234"
# ).inspect

# puts seam.access_codes.create_multiple(
#   device_ids: [lock1.device_id, lock2.device_id],
#   name: "create mult",
#   code: "4321"
# ).inspect
...
building_a = seam.acs.systems.get(
  # acs_system_id: "11111111-1111-1111-1111-111111111111"
  acs_system_id: "88885b0f-24f6-451a-923b-21d61778bd47"
)
...
access_group_ids = [
  ...
  "9777c9c5-2a33-40c7-b829-1da1e84df074"
]
