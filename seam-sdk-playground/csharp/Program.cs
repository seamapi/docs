...
// Retrieve all devices, filtered by manufacturer,
// which is one of several filters that list() supports.
var allEcobeeThermostats = seam.Devices.List(
  manufacturer: Seam.Api.Devices.ListRequest.ManufacturerEnum.Ecobee
);

// Select the first device as an example.
Device livingRoomThermostat = allEcobeeThermostats[0];

// Inspect specific properties.
Console.WriteLine("Current temperature: " + livingRoomThermostat.Properties.Locked);
// Console.WriteLine("Fan running: " + livingRoomThermostat.Properties.is_fan_running);

// View the entire returned device object.
Console.WriteLine(livingRoomThermostat);