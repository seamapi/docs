...
# Get the device by ID.
# updated_living_room_thermostat = seam.devices.get(device_id=living_room_thermostat.device_id)

# Inspect properties.hvac_mode_setting to confirm
# that setting the HVAC mode to heat was successful.
# pprint(
#   updated_living_room_thermostat.
#   properties["current_climate_setting"]["hvac_mode_setting"]
# )

# pprint(seam.devices.list_device_providers())
