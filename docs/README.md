---
description: >-
  Seam makes it easy to integrate IoT devices and systems with your
  applications!
---
...
Unlock doors. Create access codes. Set temperatures. Grant access. Get started with Seam!
...
{% embed url="https://www.youtube.com/watch?v=729VJNrSO60" %}
With the Seam API, you can grant users access to entrances controlled by a variety of access control systems. In this video, learn how to get started!
{% endembed %}
