...
Gets a [client session](../../core-concepts/workspaces/client-session-tokens.md) (`client_session` object) with specific characteristics or create a new client session with these characteristics if it does not yet exist.
