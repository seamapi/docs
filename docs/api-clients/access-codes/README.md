...
| could_not_confirm_code                           | Unable to confirm creation of the access code on device. Possible causes could be a duplicate name or pin code. Please check the list of access codes on your Kwikset app from a device that is connected to the lock via Bluetooth or contact us for further assistance                                                                                                                                                                                                               |
| could_not_delete_code                            | Unable to confirm deletion of the access code from the device. It's possible that this access code was deleted from a source other than Seam. Please check the list of access codes on your Kwikset app from a device that is connected to the lock via Bluetooth or contact us for further assistance                                                                                                                                                                                 |
