---
description: Get all Access Codes of a Device by its ID
---
...
{% swagger method="get" path="/access_codes/list" baseUrl="https://connect.getseam.com" summary="Get list of Access Codes" %}
{% swagger-description %}
...
{% tab title="Python" %}
<pre class="language-python"><code class="lang-python">seam.access_codes.list("a83690b2-2b70-409a-9a94-426699b84c97")
<strong>
...
<pre class="language-javascript"><code class="lang-javascript">await seam.accessCodes.list({
