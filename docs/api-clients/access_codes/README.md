...
{% hint style="info" %}
If the device or connected account associated with an access code has an error, it will be attached to the access code alongside any other access code errors. Treat these errors as Specific Errors. See [Device Error Types](<../devices/README (1).md#device-error-types>) and [Connected Account Error Types](../connected\_accounts/#connected-account-error-types).
{% endhint %}
...
* [Create many access codes](../access-codes/create\_multiple.md)
* [List access codes](../access-codes/list.md)
* [Get an access code](../access-codes/get.md)
* [Update an access code](../access-codes/update.md)
* [Delete an access code](../access-codes/delete.md)
* [List unmanaged access codes](../access-codes/list-1.md)
* [Convert an unmanaged access code](../access-codes/convert\_to\_managed.md)
* [Delete an unmanaged access code](../access-codes/delete-1.md)
* [Pull a backup access code](pull\_backup\_access\_code.md)
