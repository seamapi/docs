...
| `device.code_limit_reached`                          | A device has reached its limit of access codes.                                                                                                                                                                                                                                 |
| `device.connection_became_flaky`                     | A device connection has become flaky.                                                                                                                                                                                                                                           |
| `device.connection_stabilized`                       | A device connection has stabilized.                                                                                                                                                                                                                                             |
...
| `device.third_party_integration_no_longer_detected`  | A third party integration is no longer detected on the device.                                                                                                                                                                                                                  |
