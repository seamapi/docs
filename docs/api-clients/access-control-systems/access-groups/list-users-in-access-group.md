...
Returns a list of all [ACS users](../../../capability-guides/access-systems/user-management/) in an [access group](../../../products/access-systems/assigning-users-to-access-groups.md).
