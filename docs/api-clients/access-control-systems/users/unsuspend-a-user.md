...
[Unsuspends](../../../capability-guides/access-systems/user-management/suspending-and-unsuspending-users.md#unsuspend-an-acs-user) a specified suspended [ACS user](../../../capability-guides/access-systems/user-management/). While [suspending an ACS user](suspend-a-user.md) revokes their access temporarily, unsuspending the ACS user restores their access.
