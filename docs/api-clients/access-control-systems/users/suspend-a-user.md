...
[Suspends](../../../capability-guides/access-systems/user-management/suspending-and-unsuspending-users.md#suspend-an-acs-user) a specified [ACS user](../../../capability-guides/access-systems/user-management/). Suspending an ACS user revokes their access temporarily. To restore an ACS user's access, you can [unsuspend](unsuspend-a-user.md) them.
