...
[Unsuspends](../../../products/access-systems/suspending-and-unsuspending-users.md#unsuspend-an-acs-user) a specified suspended [ACS user](../../../products/access-systems/user-management.md). While [suspending an ACS user](suspend.md) revokes their access temporarily, unsuspending the ACS user restores their access.
