...
When issuing a [List Events](../../api/events/list.md) request to retrieve [`device.low_battery`](../../api/events/) or [`device.battery_status_changed`](../../api/events/) events for a specific device, include the following parameters:
