...
When issuing a [List Events](../../api/events/list.md) request to retrieve [`device.connected`](../../api/events/#event-types) or [`device.disconnected`](../../api/events/#event-types) events for a specific device, include the following parameters:
