...
To set up an enrollment automation, call the [Launch Enrollment Automation](../../api-clients/user-identities/enrollment-automations/launch.md) function with the ID of the user identity (`user_identity_id`) and the system ID of the credential manager (`credential_manager_acs_system_id`).
