...
To retrieve all [thermostats](./), issue a [List Thermostats](../../api-clients/thermostats/list.md) request. For filtering options, see the [request body parameters](../../thermostats/list.md#request-body-parameters) for the List Thermostats request.
...
To retrieve a specific [thermostat](./), include the desired `device_id` in the [Get Thermostat](../../api-clients/thermostats/get.md) or [Get Device](../../api-clients/devices/get-device.md) request.
