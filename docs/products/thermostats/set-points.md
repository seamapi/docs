...
Some models of thermostats have specific requirements and constraints related to configuring set points. You can fetch the requirements by issuing a [Get Thermostat](../../thermostats/get.md) or [List Thermostats](../../thermostats/list.md) request.&#x20;
