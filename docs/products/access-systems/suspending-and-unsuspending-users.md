...
To [suspend an ACS user](../../api-clients/acs/users/suspend-a-user.md), provide the `acs_user_id`.
...
To [unsuspend an ACS user](../../api-clients/acs/users/unsuspend-a-user.md), provide the `acs_user_id`.
