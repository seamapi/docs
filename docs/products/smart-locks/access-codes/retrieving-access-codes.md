...
To retrieve all access codes for a device, include the `device_id` in the [List Access Codes](../../../api-clients/access-codes/list.md) request.
...
To retrieve access codes by IDs, include the desired `access_code_ids` in the [List Access Codes](../../../api-clients/access-codes/list.md) request.
...
To retrieve a specific access code, include the desired `access_code_id` in the [Get Access Code](../../../api-clients/access\_codes/get/) request.
