...
Some models of thermostats have specific requirements and constraints related to configuring set points. You can fetch the requirements by issuing a [Get Device](../../../api/devices/get.md) or [List Thermostats](../../../api/thermostats/list.md) request.&#x20;
