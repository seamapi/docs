...
Some models of thermostats have specific requirements and constraints related to configuring set points. You can fetch the requirements by issuing a [Get Device](https://docs.seam.co/latest/api/devices/get) or [List Thermostats](https://docs.seam.co/latest/api/thermostats/list) request.&#x20;
