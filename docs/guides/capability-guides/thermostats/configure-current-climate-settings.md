...
* [`/thermostats/heat`](https://docs.seam.co/latest/api/thermostats/heat)
* [`/thermostats/cool`](https://docs.seam.co/latest/api/thermostats/cool)
* [`/thermostats/heat_cool`](https://docs.seam.co/latest/api/thermostats/heat_cool)
* [`/thermostats/off`](https://docs.seam.co/latest/api/thermostats/off)
* [`/thermostats/set_fan_mode`](https://docs.seam.co/latest/api/thermostats/set_fan_mode)

{% hint style="info" %}
You can also use the [`/thermostats/set_hvac_mode`](https://docs.seam.co/latest/api/thermostats/set_hvac_mode) endpoint to set a thermostat to the desired HVAC mode, including `heat`, `cool`, `heat_cool`, `eco` (for Google Nest), or `off`, depending on the capabilities of the device. For `heat`, `cool`, and `heat_cool`, also specify the desired heating and cooling set points, as appropriate.
{% endhint %}
...
Further, Seam emits a [`thermostat.temperature_reached_set_point` event](https://docs.seam.co/latest/api/events/) when the thermostat reports a temperature within 1° Celsius of the heating or cooling temperature that you requested.
...
Use the [`/devices/get`](https://docs.seam.co/latest/api/devices/get) endpoint for a specific device to return these capability flags. Then, use an `if` statement or similar check to confirm that the relevant flag is both present and `true` before attempting to perform the imperative thermostat action.

If the relevant capability flag is `false` or not present, you can view the [properties](https://docs.seam.co/latest/api/thermostats/#properties) of the device, [errors](https://docs.seam.co/latest/api/devices/#errors) or [warnings](https://docs.seam.co/latest/api/devices/#warnings) for the device, and [events](https://docs.seam.co/latest/api/events/) related to the device to learn more about the cause of these issues. For example, you could examine `device.properties.online`. In addition, you could look for a `device.disconnected` event.
...
You can [set a thermostat to heat mode](https://docs.seam.co/latest/api/thermostats/heat) or use the [`/thermostats/set_hvac_mode`](https://docs.seam.co/latest/api/thermostats/set_hvac_mode) endpoint, and specify a desired heating [set point](../../capability-guides/thermostats/understanding-thermostat-concepts/set-points.md) temperature. By establishing the set point, the thermostat activates the associated heating system to maintain the specified temperature.
...
You can [set a thermostat to cool mode](https://docs.seam.co/latest/api/thermostats/cool) or use the [`/thermostats/set_hvac_mode`](https://docs.seam.co/latest/api/thermostats/set_hvac_mode) endpoint, and specify a desired cooling [set point](../../capability-guides/thermostats/understanding-thermostat-concepts/set-points.md) temperature. By establishing the set point, the thermostat activates the associated cooling system to maintain the specified temperature.
...
You can [set a thermostat to heat-cool (also known as "auto") mode](https://docs.seam.co/latest/api/thermostats/heat_cool) or use the [`/thermostats/set_hvac_mode`](https://docs.seam.co/latest/api/thermostats/set_hvac_mode) endpoint, and specify desired [set point](../../capability-guides/thermostats/understanding-thermostat-concepts/set-points.md) temperatures for both heating and cooling. By establishing the set points, the thermostat activates the associated heating and cooling systems as needed to maintain the specified temperature range.
...
You can [set a thermostat to "off" mode](https://docs.seam.co/latest/api/thermostats/off) or use the [`/thermostats/set_hvac_mode`](https://docs.seam.co/latest/api/thermostats/set_hvac_mode) endpoint, which deactivates the associated heating and cooling systems. In this state, the thermostat does not regulate indoor temperatures.
...
You can [configure the fan mode setting for a thermostat](https://docs.seam.co/latest/api/thermostats/set_fan_mode). For details about the supported fan modes, see [Fan Mode Settings](configure-current-climate-settings.md#fan-mode-settings).
