...
Each climate preset can contain the following properties, depending on the [capabilities](../../../capability-guides/thermostats/#thermostat-capabilities) of the thermostat:
