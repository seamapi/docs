...
To [get an ACS user](../../api/acs/users/get.md), provide the `acs_user_id` of the user that you want to retrieve. These details include the contact details for the user, the user's access schedule, the associated [user identity](../../api/user_identities/), if applicable, and so on.
