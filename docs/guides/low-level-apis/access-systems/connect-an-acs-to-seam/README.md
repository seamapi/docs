...
2.  In the upper-left corner, click the workspace switcher and select or create a [workspace](../../../core-concepts/workspaces/).
    ...
    To connect a real access system to Seam, use a production workspace. To use one of Seam's [virtual access systems](https://docs.seam.co/latest/device-and-system-integration-guides), use a [sandbox workspace](../../../core-concepts/workspaces/#sandbox-workspaces).
