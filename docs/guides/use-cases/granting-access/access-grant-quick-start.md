...
1.  [Connect](../../core-concepts/workspaces/#connecting-virtual-devices) an access system to Seam.
    ...
    For instructions, see [Connect an Access System to Seam](../../low-level-apis/access-systems/connect-an-acs-to-seam/).
