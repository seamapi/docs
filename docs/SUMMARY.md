...
* [Get started with Ecobee Thermostats](device-guides/get-started-with-noiseaware-sensors.md)
...
* [Get started with NoiseAware Sensors](device-guides/get-started-with-noiseaware-sensors-1.md)
