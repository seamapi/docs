...
1. Create a [Connect Webview](https://docs.seam.co/latest/core-concepts/connect-webviews), including `salto_ks` in the set of [`accepted_providers`](https://docs.seam.co/latest/api/connect_webviews/).
