...
## 6.  Send Your Project Information to Seam

Send your Google Device Access project information securely to Seam. It is not necessary to wait for Google Commercial Development approval before sending this information to us.

1. Use [https://securesend.seam.co/](https://securesend.seam.co/) to send the following information securely to Seam:
   ...
   * Your Seam [workspace](../../core-concepts/workspaces/) ID
