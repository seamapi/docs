...
Some models of thermostats have specific requirements and constraints related to configuring set points. You can fetch the requirements by issuing a [Get Device](../../../api-clients/devices/get.md) or [List Thermostats](../../../api-clients/thermostats/list.md) request.&#x20;
