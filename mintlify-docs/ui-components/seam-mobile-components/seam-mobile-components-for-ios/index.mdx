---
title: 'Seam Mobile Components for iOS'
description: 'Learn how to set up Seam Mobile Components in your iOS project using Swift Package Manager, drop in SeamAccessView for a complete unlock flow, and customize the look with SeamTheme.'
---
...
You should already have a Seam workspace and API key set up. If you’re new to Seam, start with the [Seam Mobile SDK](/developer-tools/mobile-sdks/ios-sdk).
...
- Explore [Seam Mobile SDK](/developer-tools/mobile-sdks/ios-sdk)
