---
title: "Seam Mobile Components for Android"
description: "Learn how to set up Seam Mobile Components in your Android project using GitHub Packages, drop in SeamAccessView for a complete unlock flow, and customize the look with SeamComponentsTheme."
---
