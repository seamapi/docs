...
<CardGroup cols={2}>
<Card title="iOS GuideIntegrate Seam Mobile Components into your iOS app" href="/seam-mobile-components-for-ios/" img="/images/image (35).png">
  
</Card>
<Card title="Android GuideIntegrate Seam Mobile Components into your Android app" href="/seam-mobile-components-for-android/" img="/images/android_logo.png">
