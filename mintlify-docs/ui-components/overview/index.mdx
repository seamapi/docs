...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href='/ui-components/overview/react-components/device-details'
  ...
  <Card
    ...
    href='/ui-components/overview/react-components/access-code-table'
    img='/images/seam-component-access-code-table.png'
  ></Card>
  <Card
    title='Access Code Details'
    href='/ui-components/overview/react-components/access-code-details'
