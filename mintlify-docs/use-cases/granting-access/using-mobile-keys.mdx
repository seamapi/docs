...
To see which devices or entrances a mobile key gives access to, call `/access_methods/get_related`.
...
console.log(related.devices) // smart locks this mobile key unlocks
...
print(related.devices)        # smart locks this mobile key unlocks
