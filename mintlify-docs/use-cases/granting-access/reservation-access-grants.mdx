...
If you’re looking to issue a guest or resident credential, use the [Entrances API](/api/acs/entrances/object) to confirm which entrances support reservation semantics.
