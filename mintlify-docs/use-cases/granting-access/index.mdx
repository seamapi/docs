...
| `card` | A credential encoded onto a physical plastic card. | Hotels and offices with existing card infrastructure. |
| `cloud_key` | A remote unlock triggered on behalf of a specific user, attributed in the ACS audit trail. | Audit-traced remote access without physical credentials. |
