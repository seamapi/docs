...
1. **One device.** Connect a smart lock and create an Access Grant with a single `device_id` and a `code` access method. See [Creating an Access Grant Using Devices](creating-an-access-grant-using-devices).
2. **Multiple devices and spaces.** Pass several `device_ids` in one call to grant access to a set of locks at once. To manage groups of access points by name—for example, everything a guest in Unit 101 needs—organize them into [spaces](creating-an-access-grant-using-spaces) and grant access by `space_id`.
3. **Access control systems.** Connect an ACS, such as Salto, Visionline, or Brivo, and grant access to entrances with `acs_entrance_ids`. This path can involve additional setup, such as licenses, on-premises connections through Seam Bridge, mobile key configuration, and [reservations](reservation-access-grants) for offline-override systems. See [Creating an Access Grant Using Entrances](creating-an-access-grant-using-entrances).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        (with an{' '}
        <a href='../../capability-guides/instant-keys/README.md'>Instant Key</a>
        ).
      </td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        a{' '}
        <a href='../../core-concepts/connect-webviews/README.md'>
          Connect Webview
        </a>{' '}
        ...
        <a href='../../capability-guides/access-systems/connect-an-acs-to-seam/README.md'>
    ...
    <tr>
      ...
      <td>
        ...
        <a href='../../capability-guides/instant-keys/setting-up-your-site-for-instant-keys.md'>
    ...
    <tr>
      ...
      <td>
        ...
        <br />
        See{' '}
        <a href='creating-an-access-grant-using-devices.md'>
          Creating an Access Grant Using Devices
        </a>
        ,{' '}
        <a href='creating-an-access-grant-using-spaces.md'>
          Creating an Access Grant Using Spaces
        </a>
        , and{' '}
        <a href='creating-an-access-grant-using-entrances.md'>
    ...
    <tr>
      ...
      <td>
        ...
        <p>
          See{' '}
          <a href='delivering-access-methods.md'>Delivering Access Methods</a>.
        </p>
      </td>
    </tr>
  </tbody>
...
| Set a PIN with a specific custom code value on a single lock | [Access Codes API](../../capability-guides/smart-locks/access-codes/index) (low-level) |
| Manage offline or backup PIN code pools on a single lock     | [Access Codes API](../../capability-guides/smart-locks/access-codes/index) (low-level) |
| Directly manage ACS users, credentials, and access groups    | [ACS API](../../capability-guides/access-systems/index) (low-level)                    |
| Lock or unlock a door remotely                               | [Smart Locks API](../../capability-guides/smart-locks/index) (not a granting workflow) |

<Warning>
  The low-level [Access
  Codes](../../capability-guides/smart-locks/access-codes/index) and
  [ACS](../../capability-guides/access-systems/index) granting workflows are
...
👉 [Learn how to use reservations with Access Grants →](reservation-access-grants)

---

## Get Started

To create your first Access Grant, see the [Access Grant Quick Start](access-grant-quick-start). Then, learn more in the following topics:

- [Creating an Access Grant Using Devices](creating-an-access-grant-using-devices)
