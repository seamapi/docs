...
<Check>
  **Starting with a standalone smart lock?** The fastest first success is a
  ...
  Grant Using Devices](creating-an-access-grant-using-devices). This quick
...
<Info>
  ...
  [Instant Keys](../../capability-guides/instant-keys/).
</Info>
...
2.  Install a Seam SDK and create an API key.
    ...
    For instructions, see [Installation](https://docs.seam.co/latest/api/installation) and [API Keys](../../core-concepts/authentication/api-keys).
...
1.  Create an Access Grant.
    ...
    For instructions, see [Step 1: Create an Access Grant](access-grant-quick-start#step-1-create-an-access-grant).
...
2.  Poll for access method status changes or monitor for Access Grant and access method lifecycle events.
    ...
    For instructions, see [Step 2: Poll for Status Changes or Monitor for Lifecycle Events](access-grant-quick-start#step-2-poll-for-status-changes-or-monitor-for-lifecycle-events).

3.  Deliver the created access methods to your user.

    The delivery method depends on the access method.

    For instructions, see [Step 3: Deliver the Access Methods](access-grant-quick-start#step-3-deliver-the-access-methods).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href='../../capability-guides/access-systems/working-with-card-encoders-and-scanners/'>
    ...
    <tr>
      ...
      <td>
        ...
        <a href='../../capability-guides/instant-keys/delivering-instant-keys.md'>
...
- [Creating an Access Grant Using Entrances](creating-an-access-grant-using-entrances)
- [Creating an Access Grant Using Spaces](creating-an-access-grant-using-spaces)
- [Delivering Access Methods](delivering-access-methods)
