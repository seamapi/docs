...
To see which devices or entrances a PIN code access method covers, call `/access_methods/get_related`. This returns the devices, ACS entrances, spaces, and other resources associated with the access method.
