...
Once the access method is issued, list the access methods for the Access Grant to get the code. Share the code with your user through text, email, or your application.
