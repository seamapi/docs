...
## Step 4: List the Doors This PIN Code Applies To

An access method can cover multiple doors — for example, if the Access Grant includes several devices or entrances. To see exactly which doors a PIN code is programmed on, call `/access_methods/get_related`.
