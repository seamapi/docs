---
title: "Handling Recurring Access Codes"
...
<figure><img src="/images/image (2) (1).png" alt=""><figcaption><p>Creating a webhook for access_code.removed_from_device from console.seam.co</p></figcaption></figure>
