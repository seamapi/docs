...
<ResponseField name="client_session_id" type="String (UUID)">
  ID of the [client session](/core-concepts/authentication/client-session-tokens) associated with the Instant Key.
</ResponseField>
...
<ResponseField name="workspace_id" type="String (UUID)">
  ID of the [workspace](/core-concepts/workspaces) that contains the Instant Key.
</ResponseField>
