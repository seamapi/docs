...
**`organization_id`** _String_

ID of the organization to associate with the new workspace.

---

**`webview_logo_shape`** _String_

<Warning>
  **Deprecated**. Use `connect_webview_customization.webview_logo_shape`
  instead.
</Warning>

---

**`webview_primary_button_color`** _String_

<Warning>
  **Deprecated**. Use
  `connect_webview_customization.webview_primary_button_color` instead.
</Warning>

---

**`webview_primary_button_text_color`** _String_

<Warning>
  **Deprecated**. Use
  `connect_webview_customization.webview_primary_button_text_color` instead.
</Warning>

---

**`webview_success_message`** _String_

<Warning>
  **Deprecated**. Use `connect_webview_customization.webview_success_message`
  instead.
</Warning>
