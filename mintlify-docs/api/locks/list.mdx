...
**`connected_account_ids`** _Array_ _of UUIDs_
...
**`device_types`** _Array_ _of Enums_
...
**`unstable_location_id`** _String_

<Warning>**Deprecated**. Use `space_id`.</Warning>
