...
Represents a [lock](https://docs.seam.co/latest/low-level-apis/smart-locks).

The Seam API enables you to control connected smart locks from a wide variety of manufacturers, including locks that provide online and offline [access code](https://docs.seam.co/latest/low-level-apis/smart-locks/access-codes) programming.
...
Indicates whether the device supports a [backup access code pool](https://docs.seam.co/latest/low-level-apis/smart-locks/access-codes/backup-access-codes).
...
A [lock](https://docs.seam.co/latest/low-level-apis/smart-locks) was locked.
...
<strong>
  <code>access_code_is_managed</code>
</strong>
<i>Boolean</i>
...
A [lock](https://docs.seam.co/latest/low-level-apis/smart-locks) was unlocked.
...
Method by which the affected lock device was unlocked. When the method is `keycode`, the `access_code_id` indicates the [access code](https://docs.seam.co/latest/low-level-apis/smart-locks/access-codes) that was used, if reported by the device.
...
The [lock](https://docs.seam.co/latest/low-level-apis/smart-locks) denied access to a user after one or more consecutive invalid attempts to unlock the device.
...
Configures the auto-lock setting for a specified [lock](https://docs.seam.co/latest/low-level-apis/smart-locks).

[**`/locks/get`**](./get)

Returns a specified [lock](https://docs.seam.co/latest/low-level-apis/smart-locks).

[**`/locks/list`**](./list)

Returns a list of all [locks](https://docs.seam.co/latest/low-level-apis/smart-locks).

[**`/locks/lock_door`**](./lock_door)

Locks a [lock](https://docs.seam.co/latest/low-level-apis/smart-locks). See also [Locking and Unlocking Smart Locks](https://docs.seam.co/latest/low-level-apis/smart-locks/lock-and-unlock).

[**`/locks/unlock_door`**](./unlock_door)

Unlocks a [lock](https://docs.seam.co/latest/low-level-apis/smart-locks). See also [Locking and Unlocking Smart Locks](https://docs.seam.co/latest/low-level-apis/smart-locks/lock-and-unlock).
