...
- <strong>
    <code>device_provider_name</code>
  </strong>
  <i>String</i>
...
[**`/devices/list_device_providers`**](./list_device_providers)

Returns a list of all device providers.

[**`/devices/report_provider_metadata`**](./report_provider_metadata)
