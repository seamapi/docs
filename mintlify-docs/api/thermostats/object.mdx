...
- <strong>
  ...
  - <strong>
      <code>thermostat_schedule_id</code>
    </strong>
    <i>UUID</i>
...
- <strong>
    <code>keypad_battery_level</code>
  </strong>
  <i>String</i>
...
- <strong>
    <code>entry_relays_total_count</code>
  </strong>
  <i>Number</i>
...
- <strong>
    <code>predefined_time_slots</code>
  </strong>
  <i>List</i> <i>of Objects</i>
...
- <strong>
    <code>dormakaba_oracode_user_level_id</code>
  </strong>
  <i>UUID</i>
...
- <strong>
    <code>dormakaba_oracode_user_level_prefix</code>
  </strong>
  <i>Number</i>
...
- <strong>
    <code>reclose_delay_in_seconds</code>
  </strong>
  <i>Number</i>
...
- <strong>
    <code>honeywell_resideo_device_id</code>
  </strong>
  <i>String</i>
...
- <strong>
    <code>is_accessory_keypad_linked_to_bridge</code>
  </strong>
  <i>Boolean</i>
...
- <strong>
    <code>current_or_last_store_id</code>
  </strong>
  <i>Number</i>
...
- <strong>
    <code>current_user_company</code>
  </strong>
  <i>String</i>
...
- <strong>
    <code>current_user_phone_number</code>
  </strong>
  <i>String</i>
...
- <strong>
    <code>wifi_signal_strength</code>
  </strong>
  <i>Number</i>
...
- <strong>
    <code>latest_sensor_values</code>
  </strong>
  <i>Object</i>
...
- <strong>
    <code>latest_sensor_values.accelerometer_z</code>
  </strong>
  <i>Object</i>
...
- <strong>
    <code>latest_sensor_values.accelerometer_z.time</code>
  </strong>
  <i>String</i>
...
- <strong>
    <code>latest_sensor_values.accelerometer_z.value</code>
  </strong>
  <i>Number</i>
...
- <strong>
    <code>latest_sensor_values.humidity</code>
  </strong>
  <i>Object</i>
...
- <strong>
    <code>latest_sensor_values.humidity.time</code>
  </strong>
  <i>String</i>
...
- <strong>
    <code>latest_sensor_values.humidity.value</code>
  </strong>
  <i>Number</i>
...
- <strong>
    <code>latest_sensor_values.pressure</code>
  </strong>
  <i>Object</i>
...
- <strong>
    <code>latest_sensor_values.pressure.time</code>
  </strong>
  <i>String</i>
...
- <strong>
    <code>latest_sensor_values.pressure.value</code>
  </strong>
  <i>Number</i>
...
- <strong>
    <code>latest_sensor_values.sound</code>
  </strong>
  <i>Object</i>
...
- <strong>
    <code>latest_sensor_values.sound.time</code>
  </strong>
  <i>String</i>
...
- <strong>
    <code>latest_sensor_values.sound.value</code>
  </strong>
  <i>Number</i>
...
- <strong>
    <code>latest_sensor_values.temperature</code>
  </strong>
  <i>Object</i>
...
- <strong>
    <code>latest_sensor_values.temperature.time</code>
  </strong>
  <i>String</i>
...
- <strong>
    <code>latest_sensor_values.temperature.value</code>
  </strong>
  <i>Number</i>
...
- <strong>
    <code>keypad_battery_critical</code>
  </strong>
  <i>Boolean</i>
...
- <strong>
    <code>has_custom_pin_subscription</code>
  </strong>
  <i>Boolean</i>
...
- <strong>
    <code>dual_setpoints_not_supported</code>
  </strong>
  <i>Boolean</i>
...
- <strong>
    <code>lower_limit_fahrenheit</code>
  </strong>
  <i>Number</i>
...
- <strong>
    <code>upper_limit_fahrenheit</code>
  </strong>
  <i>Number</i>
...
- <strong>
    <code>wednesday_program_id</code>
  </strong>
  <i>UUID</i>
...
- <strong>
    <code>features.auto_lock_time_config</code>
  </strong>
  <i>Boolean</i>
...
- <strong>
    <code>features.incomplete_keyboard_passcode</code>
  </strong>
  <i>Boolean</i>
...
- <strong>
    <code>features.lock_command</code>
  </strong>
  <i>Boolean</i>
...
- <strong>
    <code>features.passcode_management</code>
  </strong>
  <i>Boolean</i>
...
- <strong>
    <code>features.unlock_via_gateway</code>
  </strong>
  <i>Boolean</i>
...
- <strong>
    <code>wireless_keypad_name</code>
  </strong>
  <i>String</i>
...
- <strong>
    <code>locker_status_hardlock</code>
  </strong>
  <i>Number</i>
