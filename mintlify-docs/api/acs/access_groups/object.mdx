...
<ResponseField name="connected_account_id" type="String (UUID)">
  ID of the [connected account](/core-concepts/connected-accounts) that contains the access group.
</ResponseField>
...
<ResponseField name="workspace_id" type="String (UUID)">
  ID of the [workspace](/core-concepts/workspaces) that contains the access group.
</ResponseField>
