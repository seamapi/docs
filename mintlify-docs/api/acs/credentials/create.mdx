...
**`access_method`** _String_ (Required)
...
**`allowed_acs_entrance_ids`** _Array_ _of UUIDs_

Set of IDs of the [entrances](https://docs.seam.co/latest/low-level-apis/access-systems/retrieving-entrance-details) for which the new credential grants access.
...
<summary>
  <b>
    <code>join_all_guest_acs_entrances</code>
  </b>{' '}
  <i>Boolean</i>
</summary>
...
<summary>
  <b>
    <code>override_all_guest_acs_entrances</code>
  </b>{' '}
  <i>Boolean</i>
</summary>
...
<summary>
  <b>
    <code>is_override_key</code>
  </b>{' '}
  <i>Boolean</i>
</summary>

<Warning>**Deprecated**. Use `override` instead.</Warning>
