...
ID of the [access control system](https://docs.seam.co/latest/low-level-apis/access-systems).
...
ID of the [connected account](https://docs.seam.co/latest/core-concepts/connected-accounts) associated with the [access control system](https://docs.seam.co/latest/low-level-apis/access-systems).

---

**`connected_account_ids`** _List_ _of UUIDs_

IDs of the [connected accounts](https://docs.seam.co/latest/core-concepts/connected-accounts) associated with the [access control system](https://docs.seam.co/latest/low-level-apis/access-systems).

<Warning>**Deprecated**. Use `connected_account_id`.</Warning>

---

**`created_at`** _Datetime_

Date and time at which the [access control system](https://docs.seam.co/latest/low-level-apis/access-systems) was created.

---

**`default_credential_manager_acs_system_id`** _UUID_

ID of the default credential manager `acs_system` for this [access control system](https://docs.seam.co/latest/low-level-apis/access-systems).

---

[**`errors`**](#errors) _List_ _of Objects_

Errors associated with the [access control system](https://docs.seam.co/latest/low-level-apis/access-systems).
...
Brand-specific terminology for the [access control system](https://docs.seam.co/latest/low-level-apis/access-systems) type.
...
Display name that corresponds to the brand-specific terminology for the [access control system](https://docs.seam.co/latest/low-level-apis/access-systems) type.

---

**`image_alt_text`** _String_

Alternative text for the [access control system](https://docs.seam.co/latest/low-level-apis/access-systems) image.

---

**`image_url`** _String_

URL for the image that represents the [access control system](https://docs.seam.co/latest/low-level-apis/access-systems).
...
- <strong>
  ...
  Time zone in which the [access control system](https://docs.seam.co/latest/low-level-apis/access-systems) is located.
...
Name of the [access control system](https://docs.seam.co/latest/low-level-apis/access-systems).

---

**`system_type`** _Enum_

<Warning>**Deprecated**. Use `external_type`.</Warning>
...
<Warning>**Deprecated**. Use `external_type_display_name`.</Warning>
...
Warnings associated with the [access control system](https://docs.seam.co/latest/low-level-apis/access-systems).
