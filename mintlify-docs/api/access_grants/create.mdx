...
**`requested_access_methods`** _Array_ _of Objects_ (Required)
...
<Warning>**Deprecated**. Use `acs_entrance_ids` at the top level.</Warning>
...
<Warning>**Deprecated**. Use `device_ids` at the top level.</Warning>
...
**`location_ids`** _Array_ _of UUIDs_
