...
**`access_grant_id`** _UUID_

ID of the Access Grant.

---

**`access_grant_key`** _String_

Unique key for the access grant within the workspace.

---

**`access_method_ids`** _List_ _of UUIDs_
...
**`location_ids`** _List_ _of UUIDs_

<Warning>**Deprecated**. Use `space_ids`.</Warning>
...
**`requested_access_methods`** _List_ _of Objects_
...
<strong>
  <code>created_access_method_ids</code>
</strong>
<i>List</i> <i>of UUIDs</i>
...
<strong>
  <code>instant_key_max_use_count</code>
</strong>
<i>Number</i>
...
**`failed_devices`** _List_ _of Objects_
