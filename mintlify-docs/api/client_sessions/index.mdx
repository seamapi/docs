...
**`connect_webview_ids`** _List_ _of UUIDs_
...
**`user_identity_ids`** _List_ _of UUIDs_
...
<Warning>**Deprecated**. Use `user_identity_id` instead.</Warning>
...
[**`/client_sessions/get_or_create`**](./get_or_create)
...
[**`/client_sessions/grant_access`**](./grant_access)
