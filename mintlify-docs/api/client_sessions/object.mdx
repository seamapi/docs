...
<ResponseField name="connect_webview_ids" type="Array">
  IDs of the [Connect Webviews](https://docs.seam.co/core-concepts/connect-webviews) associated with the client session.
</ResponseField>

<ResponseField name="connected_account_ids" type="Array">
  IDs of the [connected accounts](https://docs.seam.co/core-concepts/connected-accounts) associated with the client session.
</ResponseField>
...
<ResponseField name="workspace_id" type="String (UUID)">
  ID of the [workspace](https://docs.seam.co/core-concepts/workspaces) associated with the client session.
</ResponseField>
