...
ID of the [credential](https://docs.seam.co/latest/low-level-apis/access-systems/managing-credentials) by which you want to filter the list of returned phones.

---

**`owner_user_identity_id`** _String_
