...
- <strong>
    <code>is_early_checkin_able</code>
  </strong>
  <i>Boolean</i>
...
Errors associated with the [access code](https://docs.seam.co/latest/low-level-apis/smart-locks/access-codes).
...
Warnings associated with the [access code](https://docs.seam.co/latest/low-level-apis/smart-locks/access-codes).
