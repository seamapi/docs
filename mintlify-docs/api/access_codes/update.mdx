...
See also [Modifying Access Codes](https://docs.seam.co/latest/low-level-apis/smart-locks/access-codes/modifying-access-codes).
...
**`use_offline_access_code`** _Boolean_

<Warning>**Deprecated**. Use `is_offline_access_code` instead.</Warning>
