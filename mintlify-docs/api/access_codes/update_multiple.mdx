...
See also [Update Linked Access Codes](https://docs.seam.co/latest/low-level-apis/smart-locks/access-codes/creating-and-updating-multiple-linked-access-codes#update-linked-access-codes).
...
**`common_code_key`** _String_ (Required)
