...
You can lock a door using the [`lock_door`](https://docs.seam.co/latest/api/locks/lock_door) endpoint. To confirm the success of the action, see [Verifying the success of a lock or unlock action](lock-and-unlock#verifying-the-success-of-a-lock-or-unlock-action).
...
You can unlock a door using the [unlock_door](https://docs.seam.co/latest/api/locks/unlock_door) endpoint. To confirm the success of the action, see [Verifying the success of a lock or unlock action](lock-and-unlock#verifying-the-success-of-a-lock-or-unlock-action).
