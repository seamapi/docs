---
title: 'Smart Locks'
description: 'Learn about managing smart locks and access codes that enable you to lock and unlock doors and other entry points.'
---

<Warning>
  This is a low-level API. For granting access to smart locks, use [Access
  Grants](/use-cases/granting-access/index)—the default and recommended way to grant
  access to any physical space. We don't recommend building on the Smart Locks
  API directly unless you've discussed your use case with the Seam team at
...
- [Locking and Unlocking](/low-level-apis/smart-locks/lock-and-unlock)
- [Managing Access Codes](/low-level-apis/smart-locks/access-codes/index)
