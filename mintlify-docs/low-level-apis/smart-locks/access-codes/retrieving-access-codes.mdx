---
title: 'Retrieving Access Codes'
description: 'Learn how to retrieve access codes using various filters or by referencing their specific IDs'
---

## Retrieving All Access Codes for a Device

To retrieve all access codes for a device, include the `device_id` in the [List Access Codes](/api/access_codes/list) request.
...
To retrieve access codes by IDs, include the desired `access_code_ids` in the [List Access Codes](/api/access_codes/list) request.
