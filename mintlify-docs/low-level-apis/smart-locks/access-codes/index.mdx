...
<picture>
  <source srcset="/images/ongoing-access-code-dark.png" media="(prefers-color-scheme: dark)" />
  <img src="/images/ongoing-access-code-light.png" alt="Timeline of an ongoing access code. The code remains active until you ask Seam to remove it." />
</picture>
...
<picture>
  <source srcset="/images/time-bound-access-code-dark.png" media="(prefers-color-scheme: dark)" />
  <img src="/images/time-bound-access-code-light.png" alt="Timeline of a time-bound access code. The code remains active until the ends_at timestamp that you provide to Seam." />
</picture>
...
![72 hours before the <code>starts_at</code> timestamp, Seam inserts the
      ...
      automatically deactivated at the <code>ends_at</code> timestamp.](/images/native-code-programming-dark.png)
...
![When the <code>starts_at</code> time arrives, Seam adds the code to the
      ...
      <code>ends_at</code> timestamp.](/images/just-in-time-programming-dark.png)
