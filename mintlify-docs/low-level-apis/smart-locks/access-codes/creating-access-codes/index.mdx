...
<figure>
  <img src='/images/ongoing-access-code-light.png' alt='' />
  <figcaption>
    <p>
      Timeline of an ongoing access code. The code remains active, until you use
      the Seam API to remove it.
    </p>
  </figcaption>
</figure>
...
<figure>
  <img src='/images/ongoing-access-code-polling-verification-dark.png' alt='' />
  <figcaption>
    <p>
...
<figure>
  <img src='/images/ongoing-access-code-webhook-verification-dark.png' alt='' />
  <figcaption>
    <p>
...
<figure>
  <img src='/images/time-bound-access-code-light.png' alt='' />
  <figcaption>
    <p>
      Timeline of an time-bound access code. The code remains active until the
      ends_at timestamp that you configured using the Seam API.
    </p>
  </figcaption>
</figure>
...
<figure>
  <img
    src='/images/state-sequence-for-access-codes-lifecycle-dark.png'
    alt=''
  />
  <figcaption>
    <p>Life-cycle of a time-bound access code</p>
  </figcaption>
</figure>
...
<figure>
  <img
    src='/images/timebound-access-code-polling-verification-dark.png'
    alt=''
  />
...
<figure>
  <img
    src='/images/timebound-access-code-webhook-verification-dark.png'
    alt=''
  />
  <figcaption></figcaption>
</figure>
