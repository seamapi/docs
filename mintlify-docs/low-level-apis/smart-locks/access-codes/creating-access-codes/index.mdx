...
If either of these capability flags is `false` or not present, you can view the [properties](/core-concepts/devices#properties) of the device, [errors](/core-concepts/devices#errors) or [warnings](/core-concepts/devices#warnings) for the device, and [events](/api/events/object) related to the device to learn more about the cause of these issues. For example, you could examine the following device properties:
