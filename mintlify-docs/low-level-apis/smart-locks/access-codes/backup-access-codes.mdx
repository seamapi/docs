---
title: 'Managing Backup Access Codes'
description: 'Learn how to bullet proof your access code implementation with back up access codes.'
---
...
<Info>
  ...
  codes](/low-level-apis/smart-locks/access-codes#time-bound-access-codes) only.
</Info>
...
<Info>
  Note that we only support pulling backup codes for `time_bound` codes at this
  time.
</Info>
