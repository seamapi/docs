...
![With Seam, you can manage your access control system, granting users
      access to multiple entrances using credentials.](/images/building-acs-example.png)
...
![Seam provides the flexibility to grant access to ACS users, using the
      access methods that best suit your users' needs.](/images/acs-credential-types.png)
