...
3. Define credentials, which are the digital means of granting access, such as PIN codes, mobile keys, and plastic (RFID) cards.\
   If you are developing a mobile app to provide access for your ACS users, you can also use [Seam's iOS and Android SDKs](/developer-tools/mobile-sdks/index) that pair with the Seam API to create and manage mobile keys.
