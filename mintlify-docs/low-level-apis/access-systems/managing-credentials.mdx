...
To [list all ACS credentials](https://docs.seam.co/latest/api/acs/credentials/list) for a specific [ACS user](../../low-level-apis/access-systems/user-management), provide the `acs_user_id`.
