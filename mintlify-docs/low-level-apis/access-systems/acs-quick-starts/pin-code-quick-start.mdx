...
3. In the **Users** table, click **June Doe**, the ACS user that you created.
   ...
   ![Click the ACS user to view their credentials.](/images/pin-code-quick-start-user.png)

4. In the **Credentials** tab for the ACS user, view the **Code** for the PIN code credential that you created.

   ![View the PIN code for the credential that you created.](/images/pin-code-quick-start-code-display.png)
