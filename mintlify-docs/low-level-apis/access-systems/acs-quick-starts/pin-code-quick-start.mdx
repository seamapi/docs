---
title: 'PIN Code Quick Start'
description: 'Create your first PIN code credential to start controlling an access control system with Seam.'
---
...
3. In the **Users** table, click **June Doe**, the ACS user that you created.
   ...
   <figure>
     <img
       src='/images/pin-code-quick-start-user.png'
...
4. In the **Credentials** tab for the ACS user, view the **Code** for the PIN code credential that you created.
   ...
   <figure>
     <img
       src='/images/pin-code-quick-start-code-display.png'
       alt='View the PIN code for the credential that you created.'
     />
     <figcaption>
       <p>View the PIN code for the credential that you created.</p>
     </figcaption>
   </figure>
...
5. In the **Properties** area for the ACS user, view the user's access schedule.\
   ...
   <figure>
     <img
       src='/images/pin-code-quick-start-access-schedule.png'
       alt='View the access schedule for the ACS user.'
     />
     <figcaption>
       <p>View the access schedule for the ACS user.</p>
     </figcaption>
   </figure>
...
- [Key Card Quick Start](encodable-key-card-quick-start)
