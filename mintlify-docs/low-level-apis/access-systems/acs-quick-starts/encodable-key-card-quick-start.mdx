...
1. Find the IDs of the allowed entrances.
   ...
   5. For each of these entrances, click **...**, click **Copy Id**, and then store this entrance ID for future use.
      ...
      <figure>
        <img
          src='/images/key-card-quick-start-copy-entrance-ids.png'
          alt='Copy the IDs for the Vingcard Lock 2 and Guest Lock 1 entrances.'
        />
        <figcaption>
          <p>
            Copy the IDs for the Vingcard Lock 2 and Guest Lock 1 entrances.
          </p>
        </figcaption>
      </figure>
...
3. In the **Users** table, click **Jim Doe**, the ACS user that you created.
   ...
   <figure>
     <img
       src='/images/key-card-quick-start-user.png'
...
4. In the **Credentials** tab for the ACS user, view the following information for the key card credential that you created:
   ...
   <figure>
     <img
       src='/images/key-card-quick-start-entrances-and-access-schedule.png'
       alt='View the entrances and access schedule for the credential that you created.'
     />
     <figcaption>
       <p>
