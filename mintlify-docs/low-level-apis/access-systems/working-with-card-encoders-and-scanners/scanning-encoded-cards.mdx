...
description: 'Learn how to scan an encoded card to retrieve useful information about the card.'
---

<figure>
  <img src='/images/scan-card.png' alt='' />
...
1. Initiate the scanning process.\
   ...
   See [Initiate the Scanning Process](scanning-encoded-cards#initiate-the-scanning-process).
2. Poll the returned action attempt, until its `status` becomes `success`.\
   See [Confirm Successful Scan](scanning-encoded-cards#confirm-successful-scan).
3. View the scanned card payload.\
   ...
   See [View the Scanned Card Payload](scanning-encoded-cards#view-the-scanned-card-payload). Also, see a list of [common scanning errors](scanning-encoded-cards#common-scanning-errors).
