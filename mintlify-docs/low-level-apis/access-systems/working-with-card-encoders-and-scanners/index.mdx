...
<figure><img src="/images/card-scanner.png" alt="" /><figcaption></figcaption></figure>
...
<CardGroup cols={2}>
<Card title="Creating and Encoding Card-based Credentials" href="/creating-and-encoding-card-based-credentials" img="/images/encode-card.png">
  
</Card>
<Card title="Creating and Encoding Card Access Methods" href="/creating-and-encoding-card-access-methods" img="/images/encode-card.png">
  
</Card>
<Card title="Scanning Encoded Cards" href="/scanning-encoded-cards" img="/images/scan-card.png">
