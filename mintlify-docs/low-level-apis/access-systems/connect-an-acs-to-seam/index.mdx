...
5.  In the Connect Webview, follow the prompts to authorize the connection.
    ...
    <figure><img src="/images/salto webview.webp.png" alt="Use a Connect Webview to connect your access system to Seam." /><figcaption><p>Use a Connect Webview to connect your access system to Seam.</p></figcaption></figure>
