---
title: 'Connect an Access System to Seam'
description: 'Learn how to connect your access system to Seam.'
---

You can use [Seam Console](/core-concepts/seam-console/index) or the [Seam API](https://docs.seam.co/latest/api/connect_webviews/) to connect your access system to Seam. You use a [Connect Webview](/core-concepts/connect-webviews/index) to authorize the connection.
...
2. In the upper-left corner, click the workspace switcher and select or create a [workspace](/core-concepts/workspaces/index).
   ...
   To connect a real access system to Seam, use a production workspace. To use one of Seam's [virtual access systems](https://docs.seam.co/latest/device-and-system-integration-guides), use a [sandbox workspace](/core-concepts/workspaces/index#sandbox-workspaces).
...
5. In the Connect Webview, follow the prompts to authorize the connection.
   ...
   <figure>
     <img
       ...
       alt='Use a Connect Webview to connect your access system to Seam.'
     />
     <figcaption>
