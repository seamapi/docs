---
title: 'Go Live!'
description: 'Follow this guide to get your production API keys and customize your Connect Webviews.'
---

## Create a Production Workspace

When you first sign up for Seam, [Seam Console](/core-concepts/seam-console/index) automatically creates a [sandbox workspace](/core-concepts/workspaces/index#sandbox-workspaces) for you. Sandbox workspaces are great for testing with virtual devices, but once you are ready to connect a real device, you must first create a [production workspace](/core-concepts/workspaces/index#production-workspaces).
