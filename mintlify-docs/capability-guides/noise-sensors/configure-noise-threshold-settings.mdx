---
title: 'Configuring Noise Threshold Settings'
description: 'Learn how to configure noise thresholds for noise sensors.'
---

Seam enables you to configure the [noise thresholds](#set-up-noise-thresholds) of your noise sensor, as well as to receive events when a disturbance is detected. This guide walks you through how to configure noise thresholds with the Seam API.

## Set Up Noise Thresholds

First, create a threshold using the [Create a Noise Threshold](/api/noise_sensors/noise_thresholds/create) endpoint. For example:
...
2. On the **Webhooks** page, click **+ Add Webhook**.
   ...
   <img src="/images/add-webhook-button.png" alt="On the Webhooks page in the Seam Console, click + Add Webhook." style={{width: "550px", height: "auto"}} />
