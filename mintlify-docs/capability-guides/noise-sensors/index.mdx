...
description: 'Learn about managing noise sensors that detect noise levels that exceed configured thresholds in specific areas.'
---
...
- [Noise Sensors API Reference](/api/noise_sensors/object)
