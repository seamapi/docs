...
<figure><img src="/images/Typical.png" alt="Example: Share an Instant Key using a text message."><figcaption><p>Example: Share an Instant Key using a text message.</p></figcaption></figure>
...
<figure><img src="/images/instant-key-embedded-in-app.png" alt="Example: Embed an Instant Key in an app."><figcaption><p>Example: Embed an Instant Key in an app.</p></figcaption></figure>
