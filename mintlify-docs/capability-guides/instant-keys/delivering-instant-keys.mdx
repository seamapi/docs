---
title: 'Delivering Instant Keys'
description: 'Learn how to deliver Instant Keys to your users, through text, email, or your own app.'
---
...
- [Share through SMS or email.](delivering-instant-keys#share-through-sms-or-email)
- [Embed in a web or mobile app.](delivering-instant-keys#embed-in-a-web-or-mobile-app)
...
<figure>
  <img
    src='/images/Typical.png'
    alt='Example: Share an Instant Key using a text message.'
  />
  <figcaption>
    <p>Example: Share an Instant Key using a text message.</p>
  </figcaption>
</figure>
...
<figure>
  <img
    src='/images/instant-key-embedded-in-app.png'
    alt='Example: Embed an Instant Key in an app.'
  />
  <figcaption>
    <p>Example: Embed an Instant Key in an app.</p>
  </figcaption>
</figure>
