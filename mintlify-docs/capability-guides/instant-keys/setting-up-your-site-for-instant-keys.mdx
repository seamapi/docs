---
title: 'Setting Up Your Site for Instant Keys'
...
- [Bluetooth compatibility for door locks](#bluetooth-compatibility-for-door-locks)
- [License requirements](#license-requirements)

Fulfilling these requirements ensures that guests can unlock doors using mobile credentials over Bluetooth.

Then, [connect your access system to Seam](#connect-your-access-system-to-seam).
...
<table>
  <thead>
    <tr>
      <th width='282.800048828125'>Access System</th>
      <th>BLE Requirements and Support</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Salto KS</td>
      <td>All locks support BLE mobile keys right out of the box.</td>
    </tr>
    <tr>
      <td>Salto Space</td>
      <td>All locks support BLE mobile keys right out of the box.</td>
    ...
    <tr>
      <td>ASSA ABLOY Visionline and Vostio (Vingcard locks)</td>
      <td>
        Requires specific hardware and licensing. See{' '}
        <a href='#vingcard-lock-requirements'>
...
<figure>
  <img src='/images/image-(8)-(2).png' alt='LCU examples' />
  <figcaption>
    <p>LCU examples</p>
  </figcaption>
</figure>
...
To connect your access system to Seam, we recommend embedding a [Connect Webview](/core-concepts/connect-webviews/index) in your application. The Connect Webview flow guides the property manager through each step of the connection process.

<figure>
  <img
    src='/images/salto-webview.webp.png'
    alt='Example: Connect Webview for Salto systems'
  />
  <figcaption>
    <p>Example: Connect Webview for Salto systems</p>
  </figcaption>
</figure>
...
<figure>
  <img src='/images/image-(9)-(2).png' alt='Seam Bridge' />
  <figcaption>
    <p>Seam Bridge</p>
  </figcaption>
</figure>

For detailed connection instructions, see the [system integration guide](/device-and-system-integration-guides#access-control-systems) for your access system.
