...
- [Bluetooth compatibility for door locks](setting-up-your-site-for-instant-keys#confirm-bluetooth-compatibility-for-door-locks)
- [License requirements](setting-up-your-site-for-instant-keys#purchase-the-required-licenses)

Fulfilling these requirements ensures that guests can unlock doors using mobile credentials over Bluetooth.

Then, [connect your access system to Seam](setting-up-your-site-for-instant-keys#connect-the-access-system-to-seam).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href='setting-up-your-site-for-instant-keys#vingcard-lock-requirements'>
