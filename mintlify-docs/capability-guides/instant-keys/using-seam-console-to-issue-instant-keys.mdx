...
You can use Seam Console to issue Instant Keys. This process assumes that you have already [connected your access system to Seam](setting-up-your-site-for-instant-keys#connect-your-access-system-to-seam) and includes the following steps:
...
For more information about sharing Instant Keys with your users, see [Delivering Instant Keys](delivering-instant-keys).
