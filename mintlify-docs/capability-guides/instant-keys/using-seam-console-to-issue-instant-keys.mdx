...
5. At the upper-left of the access system page, click **Add user**.
   ...
   ![Click <strong>Add user</strong> to add the user to whom you want to
         grant access.](/images/access-system-add-user-button.png)
...
7. On the **Users** table, click the access system user that you created.
   ...
   <img src="/images/acs-user-table.png" alt="Click the new access system user that you created." style={{width: "550px", height: "auto"}} />
...
8. At the left of the user page, click **User identity** to expand the **User identity** area.
   ...
   ![Expand the <strong>User identity</strong> area to link the access
         system user to a user identity.](/images/acs-user-user-identity-area.png)

9. Click **Link to user identity**.
10. In the **Choose a Seam user identity** dialog, click **New user identity**.

    <img src="/images/new-user-identity-link.png" alt="Click <strong>New user identity</strong>." style={{width: "400px", height: "auto"}} />
...
12. If your access system supports access groups:
    ...
    2. In the upper-right corner of the user page, click <img src="/images/three-dot-menu-button.png" alt="" data-size="line" />and select **Manage Access**.
       ...
       ![Click <strong>Manage Access</strong> to assign the user to an
             access group.](/images/manage-access-link.png)
...
13. At the left side of the user page, click **Add Credential**.
    ...
    ![Click <strong>Add Credential</strong> to create a mobile key for the
          access system user.](/images/add-credential-link.png)
...
17. In the **User identity** area at the left of the user page, click the user identity linked to the access system user.
    ...
    ![Click the linked user identity.](/images/linked-user-identity-for-user.png)
...
18. In the **Instant Key** area at the left of the user identity page, click **Generate Instant Key**.
    ...
    ![Click <strong>Generate Instant Key</strong>. This key contains all the
          mobile credentials for the user identity.](/images/generate-instant-key-button.png)
...
![Share the Instant Key link with your user. With no app install required,
      your user just taps to unlock.](/images/instant-key-link-dialog.png)
