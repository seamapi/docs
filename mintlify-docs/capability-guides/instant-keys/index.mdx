...
<figure>
  <img
    src='/images/InstantKeyGIF.gif'
    alt='Seam Instant Keys are a prebuilt, Seam-hosted solution that enables you to share access using a link—no app download required.'
    width='375'
  />
  <figcaption>
    <p>
      Seam Instant Keys are a prebuilt, Seam-hosted solution that enables you to
      share access using a link—no app download required.
    </p>
  </figcaption>
</figure>
...
<figure>
  <img
    src='/images/Screenshot 2025-04-08 at 6.22.38 PM.png'
    alt='Launch an App Clip from a text message.'
    width='188'
  />
  <figcaption>
    <p>Launch an App Clip from a text message.</p>
  </figcaption>
</figure>
