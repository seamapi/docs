...
![Seam Instant Keys are a prebuilt, Seam-hosted solution that enables you to
      share access using a link—no app download required.](/images/InstantKeyGIF.gif)
...
<img src="/images/Screenshot-2025-04-08-at-6.22.38-PM.png" alt="Launch an App Clip from a text message." style={{width: "440px", height: "auto"}} />
