...
<figure>
  <img
    src='/images/identities accounts.png'
    alt='Each user identity is mapped to a user account in your app.'
    width='563'
  />
...
<figure>
  <img
    src='/images/acs identites.png'
    alt='A user identity can be connected to an ACS user in each ACS.'
    width='563'
  />
  <figcaption></figcaption>
</figure>
