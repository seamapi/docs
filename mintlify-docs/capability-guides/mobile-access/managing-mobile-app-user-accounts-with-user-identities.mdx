...
![Each user identity is mapped to a user account in your app.](/images/identities-accounts.png)
...
![A user identity can be connected to an ACS user in each ACS.](/images/acs-identites.png)
