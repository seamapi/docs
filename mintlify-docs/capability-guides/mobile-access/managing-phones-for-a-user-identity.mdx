...
<figure>
  <img
    ...
    alt='When a user sign in to a new phone, Seam also issues matching credentials to the new phone.'
  />
...
<figure>
  <img
    ...
    alt='When a phone is revoked, Seam revokes all the credentials issued to this phone.'
  />
  <figcaption></figcaption>
</figure>
