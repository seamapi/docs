---
title: 'Using Unlock With Tap'
description: 'This feature enables your app to perform unlock operations using mobile credentials.'
---
...
<Tab title="iOS Swift">
<Info>
If the Apple Wallet dialog appears when using the BLE unlock, see [Handling System Permissions](/capability-guides/mobile-access/mobile-device-sdks/handling-system-permissions#platform-setup-requirements) for steps to prevent it and ensure a smoother unlockWithTap experience.
</Info>
