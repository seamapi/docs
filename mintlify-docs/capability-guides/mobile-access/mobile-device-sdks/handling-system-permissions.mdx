---
title: 'Handling System Permissions'
description: "Detect and resolve missing system permissions like Bluetooth and connectivity in your mobile app by handling the Seam SDK's credential errors."
---
