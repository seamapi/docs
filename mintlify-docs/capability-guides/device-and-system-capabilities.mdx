...
![In the Seam API, capability flags inform your application about what features and behaviors each device supports.](/images/blog-cover_new-capabilities.png)
...
![Capability flags help you to understand which actions a device can
      perform.](/images/capability-flags-explained-online-access-code.png)
...
![Capability flags help you to understand why a device cannot currently
      perform an action.](/images/capability-flags-explained-remote-unlock.png)
