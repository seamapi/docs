...
Each device that you connect to Seam has a specific set of capabilities. These capabilities define the Seam API actions that you can use. For example, some devices support [remote unlock actions](../low-level-apis/smart-locks/lock-and-unlock), while others support [programming access codes](../low-level-apis/smart-locks/access-codes/). Some devices support both of these capabilities. When developing your application, it is imperative to be able to identify the capabilities of each device.
...
<Info>
  ...
  Providers](https://docs.seam.co/latest/api/devices/list_device_providers). If
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Indicates whether the device can{' '}
        <a href='../low-level-apis/smart-locks/access-codes/offline-access-codes.md'>
    ...
    <tr>
      ...
      <td>
        ...
        <a href='thermostats/understanding-thermostat-concepts/hvac-mode.md'>
          heat mode
        </a>
        .<br />
