---
title: 'Device and System Capabilities'
description: 'Learn about device and system capabilities, as well as capability flags.'
---

<figure>
  <img
    src='/images/blog-cover_new-capabilities.png'
    alt='In the Seam API, capability flags inform your application about what features and behaviors each device supports.'
  />
  <figcaption></figcaption>
</figure>

Each device that you connect to Seam has a specific set of capabilities. These capabilities define the Seam API actions that you can use. For example, some devices support [remote unlock actions](../low-level-apis/smart-locks/lock-and-unlock), while others support [programming access codes](/low-level-apis/smart-locks/access-codes/index). Some devices support both of these capabilities. When developing your application, it is imperative to be able to identify the capabilities of each device.
...
<figure>
  <img
    src='/images/capability-flags-explained-online-access-code.png'
    alt='Capability flags help you to understand which actions a device can perform.'
    width='563'
  />
  <figcaption>
    <p>
      Capability flags help you to understand which actions a device can
      perform.
    </p>
  </figcaption>
</figure>
...
- If `false`, the device has this capability, but the capability is not currently functional.
  ...
  See the device [errors](/core-concepts/devices#errors) and [warnings](/core-concepts/devices#warnings) for more details about the cause of this issue. You can also examine the [properties](/core-concepts/devices#properties) of the device and [events](/api/events/object) related to the device to learn more about the cause of this issue.
...
<figure>
  <img
    src='/images/capability-flags-explained-remote-unlock.png'
    alt='Capability flags help you to understand why a device cannot currently perform an action.'
    width='563'
  />
  <figcaption>
    <p>
      Capability flags help you to understand why a device cannot currently
      perform an action.
    </p>
  </figcaption>
</figure>

Seam recommends adding capability checks before performing specific actions in your app. For example, before performing a [remote unlock](../low-level-apis/smart-locks/lock-and-unlock#unlocking-a-door) operation, you can check to make sure that the target device supports remote unlocking. For details and code samples, see the corresponding capability guides.
...
<Info>
  ...
  Providers](/api/devices/list_device_providers). If
  at least one supported device from a provider has a specific capability, the
  corresponding capability flag is `true`.
</Info>

<table>
  <thead>
    <tr>
      <th width='204'>Property</th>
      <th width='128.33333333333331'>Type</th>
      <th>Description</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>
        <code>device.can_remotely_unlock</code>
      </td>
      <td>
        Boolean
        <br />
      ...
      <td>
        Indicates whether the device can perform a{' '}
    ...
    <tr>
      <td>
        <code>device.can_remotely_lock</code>
      </td>
      <td>
        Boolean
        <br />
    ...
    <tr>
      <td>
        <code>device.can_program_online_access_codes</code>
      </td>
      <td>
        Boolean
        <br />
      ...
      <td>
        ...
        .<br />
        If <code>true</code>, it is currently possible to create new online
    ...
    <tr>
      <td>
        <code>device.can_program_offline_access_codes</code>
      </td>
      <td>
        Boolean
        <br />
      ...
      <td>
        ...
        .<br />
        When this flag is <code>true</code>, Seam can generate an offline code
        for this device, regardless of the current online status of the device.
      </td>
    </tr>
    <tr>
      <td>
        <code>device.can_hvac_heat</code>
      </td>
      <td>
        Boolean
        <br />
      ...
      <td>
        Indicates whether the thermostat device (in conjunction with the
        associated HVAC system) supports{' '}
        <a href='/capability-guides/thermostats/understanding-thermostat-concepts/hvac-mode'>
          heat mode
        </a>
        .<br />
        When this flag is <code>true</code>, you can{' '}
        <a href='../capability-guides/thermostats/configure-current-climate-settings#set-a-thermostat-to-heat-mode'>
    ...
    <tr>
      <td>
        <code>device.can_hvac_cool</code>
      </td>
      <td>
        Boolean
        <br />
      ...
      <td>
        ...
        .<br />
        When this flag is <code>true</code>, you can{' '}
        <a href='../capability-guides/thermostats/configure-current-climate-settings#set-a-thermostat-to-cool-mode'>
    ...
    <tr>
      <td>
        <code>device.can_hvac_heat_cool</code>
      </td>
      <td>
        Boolean
        <br />
      ...
      <td>
        ...
        .<br />
        When this flag is <code>true</code>, you can{' '}
        <a href='../capability-guides/thermostats/configure-current-climate-settings#set-a-thermostat-to-heat-cool-mode'>
    ...
    <tr>
      <td>
        <code>device.can_turn_off_hvac</code>
      </td>
      <td>
        Boolean
        <br />
      ...
      <td>
        ...
        .<br />
        When this flag is <code>true</code>, you can{' '}
        <a href='../capability-guides/thermostats/configure-current-climate-settings#turn-off-heating-and-cooling'>
          set the thermostat to "off" mode
        </a>
        , which turns off both the heating and cooling systems for the space.
      </td>
    </tr>
  </tbody>
</table>
