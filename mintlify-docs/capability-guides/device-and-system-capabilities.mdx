  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href='../capability-guides/thermostats/configure-current-climate-settings.md#set-a-thermostat-to-heat-mode'>
    ...
    <tr>
      ...
      <td>
        ...
        .<br />
        When this flag is <code>true</code>, you can{' '}
        <a href='../capability-guides/thermostats/configure-current-climate-settings.md#set-a-thermostat-to-cool-mode'>
    ...
    <tr>
      ...
      <td>
        ...
        .<br />
        When this flag is <code>true</code>, you can{' '}
        <a href='../capability-guides/thermostats/configure-current-climate-settings.md#set-a-thermostat-to-heat-cool-mode'>
    ...
    <tr>
      ...
      <td>
        ...
        .<br />
        When this flag is <code>true</code>, you can{' '}
        <a href='../capability-guides/thermostats/configure-current-climate-settings.md#turn-off-heating-and-cooling'>
