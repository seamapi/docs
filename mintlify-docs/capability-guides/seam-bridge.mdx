...
<figure><img src="/images/seam-bridge-download-area.png" alt="Download the Seam Bridge application for your operating system."><figcaption><p>Download the Seam Bridge application for your operating system.</p></figcaption></figure>
...
<CardGroup cols={2}>
<Card title="Windows Setup" href="/seam-bridge/seam-bridge-setup-for-windows" img="/images/image (38).png">
  
</Card>
<Card title="macOS Setup" href="/seam-bridge/seam-bridge-setup-for-macos" img="/images/image (45).png">
  
</Card>
<Card title="Linux Setup" href="/seam-bridge/seam-bridge-setup-for-linux" img="/images/image (46).png">
...
<figure><img src="/images/seam-bridge-connected-systems-info.png" alt="Seam Bridge displays information about the connections to on-premises access systems." width="375"><figcaption><p>Seam Bridge displays information about the connections to on-premises access systems.</p></figcaption></figure>
