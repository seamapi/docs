...
2.  Enter a name for the site that you are connecting using Seam Bridge—for example, `My Site`—and then click **Start pairing**.
    ...
    ![](</images/Screenshot 2025-11-13 at 11.07.19 AM.png>)
...
1.  In the right-hand **Actions** pane, select **Create Task…** (not _Create Basic Task_).\
    ...
    <figure><img src="/images/Task Scheduler - Create Task....png" alt=""><figcaption></figcaption></figure>
...
2. In the **General** tab:
   ...
   *   Pick the right OS under **Configure for** (e.g. Windows 10/11).\
       ...
       <figure><img src="/images/Screenshot 2025-11-13 at 3.43.54 PM.png" alt=""><figcaption></figcaption></figure>
...
3.  **Set up trigger to launch at start up**
    ...
    * Make sure **Enabled** is checked, then click **OK**.
    ...
    <figure><img src="/images/Screenshot 2025-11-13 at 8.32.45 AM.png" alt=""><figcaption></figcaption></figure>
...
4.  **Add another trigger to relaunch Seam Bridge if it closes**
    ...
    <figure><img src="/images/Screenshot 2025-11-13 at 3.19.04 PM.png" alt=""><figcaption></figcaption></figure>
...
5.  **Configure launching the Seam Bridge app**
    ...
    * Click **OK**.
    ...
    <figure><img src="/images/Screenshot 2025-11-13 at 9.02.46 AM.png" alt=""><figcaption></figcaption></figure>
6.  &#x20;**Configure settings for relaunching**
    ...
    <figure><img src="/images/Screenshot 2025-11-13 at 9.37.06 AM.png" alt=""><figcaption></figcaption></figure>
...
7. **Prevent power settings from stopping the task**
   ...
   *   If this is a plugged-in machine (kiosk/server style):
       ...
       * Uncheck **Stop if the computer switches to battery power**.
       ...
       <figure><img src="/images/Screenshot 2025-11-13 at 9.46.57 AM.png" alt=""><figcaption></figcaption></figure>
