...
<CardGroup cols={2}>
  <Card
    ...
    href='/capability-guides/customer-portals/preview-the-customer-portal-in-console'
  ...
  <Card
    ...
    href='/capability-guides/customer-portals/integrate-customer-portal-into-your-application'
