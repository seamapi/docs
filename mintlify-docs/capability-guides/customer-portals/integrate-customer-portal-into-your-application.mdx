---
title: 'Integrate customer portal into your application'
description: 'Generate Customer Portals programmatically with the create_portal endpoint, or grab a ready-made code snippet from the Seam Console.'
---
...
3. In Generate Portal → **Create Portal Programmatically**, open the code panel.
   ...
   <img src="/images/Screenshot-2025-09-02-at-12.36.08-AM.png" alt="" style={{width: "400px", height: "auto"}} />
