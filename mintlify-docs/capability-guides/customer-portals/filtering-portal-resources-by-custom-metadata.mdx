---
title: 'Filtering Portal Resources by Custom Metadata'
description: 'Use customer_resources_filters to control which resources are visible to customers in a portal, based on custom_metadata on property_listings and reservations.'
---
