...
Once you create climate presets, you can [activate them](https://docs.seam.co/latest/api/thermostats/activate_climate_preset), add them to thermostat [schedules](../creating-and-managing-thermostat-schedules) and [programs](../creating-and-managing-thermostat-programs), and set them as the [fallback climate preset](setting-the-fallback-climate-preset).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Desired{' '}
        <a href='../understanding-thermostat-concepts/hvac-mode.md'>
          HVAC mode
        </a>{' '}
    ...
    <tr>
      ...
      <td>
        ...
        <a href='../understanding-thermostat-concepts/set-points.md'>
          Set Points
        </a>
        .
      </td>
