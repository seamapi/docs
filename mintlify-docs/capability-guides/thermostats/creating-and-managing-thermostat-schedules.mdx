...
<figure><img src="/images/multiple-climate-schedules.png" alt="Seam handles a fallback climate preset, along with multiple thermostat schedules." /><figcaption><p>Seam handles a fallback climate preset, along with multiple thermostat schedules.</p></figcaption></figure>
