...
- [`/thermostats/simulate/hvac_mode_adjusted`](testing-your-thermostat-app-with-simulate-endpoints#simulate-adjusting-the-hvac-mode)
- [`/thermostats/simulate/temperature_reached`](testing-your-thermostat-app-with-simulate-endpoints#simulate-reaching-a-desired-temperature)
