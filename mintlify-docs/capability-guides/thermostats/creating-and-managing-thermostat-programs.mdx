...
2. [Create the daily programs](creating-and-managing-thermostat-programs#create-a-daily-program) that you want to use in your weekly program. In each daily program, define a set of time periods. For each of these time periods, specify the starting time for the period and the key that identifies the climate preset that you want to activate at the starting time.
3. [Update the weekly program](creating-and-managing-thermostat-programs#update-the-weekly-program) on the thermostat. To define the weekly program, specify the configured daily program that you want to apply to each day of the week.
