...
3.  In the **Users** table, click **Jen Doe**, the ACS user that you created.
    ...
    <figure><img src="/images/mobile-key-quick-start-user.png" alt="Click the ACS user to view their credentials."><figcaption><p>Click the ACS user to view their credentials.</p></figcaption></figure>
