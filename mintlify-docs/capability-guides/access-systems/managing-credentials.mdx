...
<Info>
  ...
  user](managing-credentials/assigning-credentials-to-users.md#assign-a-credential-to-a-user).
  Further, you can [unassign a credential from an ACS
  user](managing-credentials/assigning-credentials-to-users.md#unassign-a-credential-from-a-user)
...
<Info>
  ...
  Credentials](working-with-card-encoders-and-scanners/creating-and-encoding-card-based-credentials.md).
</Info>
