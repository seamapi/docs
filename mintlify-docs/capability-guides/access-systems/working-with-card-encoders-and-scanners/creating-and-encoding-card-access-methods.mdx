...
<Info>
  **Early Access Preview.** The Access Grants and access methods APIs are
  currently in Alpha. We're actively developing them and seeking early feedback
  at [support@seam.co](mailto:support@seam.co). Expect breaking changes as we
  refine the design.
</Info>
...
1.  Create an [Access Grant](../../../use-cases/granting-access/) that includes a request for a card access method and identify the ID of the resulting access method.
    ...
    See [Create an Access Grant](creating-and-encoding-card-access-methods#id-1.-create-an-access-grant).
...
2.  Use the `/acs/encoders/list` endpoint to retrieve a list of available encoders. Then, choose the encoder that you want to use to write the access method onto the card.\
    See [Retrieve Encoders](creating-and-encoding-card-access-methods#id-2.-retrieve-encoders).
3.  Use the `/access_methods/encode` endpoint to encode the access method onto the card, using the encoder that you have chosen.\
    See [Encode the Card](creating-and-encoding-card-access-methods#id-3.-encode-the-card).
4.  Confirm that the card was encoded successfully using polling or a [webhook](../../../developer-tools/webhooks).\
    See [Confirm Successful Encoding](creating-and-encoding-card-access-methods#id-4.-confirm-successful-encoding). Also, see a list of [common encoding errors](creating-and-encoding-card-access-methods#common-encoding-errors).
...
For more details about creating Access Grants, see [Creating an Access Grant Using Entrances](../../../use-cases/granting-access/creating-an-access-grant-using-entrances) and [Creating an Access Grant Using Spaces](../../../use-cases/granting-access/creating-an-access-grant-using-spaces).
