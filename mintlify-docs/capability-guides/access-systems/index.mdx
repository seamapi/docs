...
<CardGroup cols={2}>
  <Card
    ...
    href='/../../capability-guides/access-systems/acs-quick-starts/pin-code-quick-start'
    img='/images/pin-code.png'
  ></Card>
  <Card
    title='Create your first encodable key card credential. →'
    href='/../../capability-guides/access-systems/acs-quick-starts/encodable-key-card-quick-start'
    img='/images/key-card.png'
  ></Card>
  <Card
    title='Create your first mobile key credential. →'
    href='/../../capability-guides/access-systems/acs-quick-starts/mobile-key-quick-start'
...
2. Learn about ACS concepts.
   ...
   - [Understanding ACS Differences](../../capability-guides/access-systems/connect-an-acs-to-seam/understanding-access-control-system-differences)
