---
title: 'Access Control System Resources'
...
<figure>
  <img
    ...
    alt='Seam&#x27;s ACS resources provide the flexibility to manage your ACS intuitively, regardless of the differences between various ACS manufacturers.'
  />
  <figcaption>
    <p>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <p>
          <img src='/images/acs-system_light.png' alt='' data-size='original' />
        </p>
        <p>
          <a href='https://docs.seam.co/latest/api/acs/systems'>
            <code>acs_system</code>
          </a>
        </p>
      </td>
      <td>
        ...
        <a href='retrieving-acs-system-details.md'>
    ...
    <tr>
      <td>
        <p>
          <img src='/images/acs-user_light.png' alt='' data-size='original' />
        </p>
        <p>
      ...
      <td>
        ...
        <p>
          ...
          <a href='../retrieving-entrance-details.md'>entrances</a> in multiple
          ACSs, you can also use Seam{' '}
          <a href='https://docs.seam.co/latest/api/user_identities'>
            user identities
          </a>
          ...
          <br />
          For more information, see{' '}
          <a href='../../../capability-guides/access-systems/user-management.md'>
            Managing ACS Users
          </a>
          .
        </p>
    ...
    <tr>
      <td>
        <p>
          <img
            src='/images/acs-access-group_light.png'
            alt=''
            data-size='original'
          />
        </p>
      ...
      <td>
        ...
        <br />
        For more information, see{' '}
        <a href='../user-management/assigning-users-to-access-groups.md'>
    ...
    <tr>
      <td>
        <p>
          <img
            src='/images/acs-credential_light.png'
            alt=''
            data-size='original'
          />
        </p>
      ...
      <td>
        ...
        <br />
        For more information, see{' '}
        <a href='../managing-credentials.md'>Managing Credentials</a>.
      </td>
    </tr>
    <tr>
      <td>
        <p>
          <img
            src='/images/acs-entrance_light.png'
            alt=''
            data-size='original'
          />
        </p>
      ...
      <td>
        ...
        <br />
        For more information, see{' '}
        <a href='../retrieving-entrance-details.md'>
