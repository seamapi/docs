---
title: 'Android SDK'
description: 'Build native Android apps for mobile access and smart device management with the Seam Android SDK, compatible with Android 12 and above.'
---

Seam SDK enables you to build your own mobile app that supports mobile access or smart device management.

Get started with our [integration guide ](/capability-guides/mobile-access/mobile-device-sdks/index)and sample integration (Coming soon!), or browse the [SDK reference documentation](https://android.seam.vc/).
