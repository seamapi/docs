...
<CardGroup cols={2}>
  <Card
    title='Seam Android SDK'
    href='https://github.com/seamapi/docs/blob/main/docs/developer-tools/mobile-sdks/android-sdk'
  ></Card>
  <Card
    title='Seam iOS SDK'
    href='https://github.com/seamapi/docs/blob/main/docs/developer-tools/mobile-sdks/ios-sdk'
  ></Card>
</CardGroup>
