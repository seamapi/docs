...
<img src="/images/add-webhook-button.png" alt="Click + Add Webhook to create a webhook for your device events." style={{width: "550px", height: "auto"}} />

You can specify any public URL endpoint to receive webhook events by pasting the URL into the **Create Webhook** dialog.

<img src="/images/create-webhook-dialog.png" alt="You can specify any internet-accessible URL as your webhook URL." style={{width: "400px", height: "auto"}} />
...
<img src="/images/testing-your-webhooks.png" alt="Use the webhooks playground to test events." style={{width: "550px", height: "auto"}} />
