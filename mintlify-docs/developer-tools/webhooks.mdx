...
![You can specify any internet-accessible URL as your webhook URL.](/images/create-webhook-dialog.png)
...
![Use the webhooks playground to test events.](/images/testing-your-webhooks.png)
