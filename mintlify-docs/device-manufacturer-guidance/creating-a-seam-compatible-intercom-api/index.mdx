---
title: 'Creating a Seam-Compatible Intercom API'
---
...
1. [Creating OAuth Endpoints](creating-oauth-endpoints)
2. [Creating Intercom Endpoints](creating-intercom-crud-endpoints)
3. [Creating Access Code Endpoints](creating-access-code-crud-endpoints)
