...
If the request is invalid or the device cannot accept changes, your API should return [an error response](#common-error-responses) immediately instead of a pending status.
