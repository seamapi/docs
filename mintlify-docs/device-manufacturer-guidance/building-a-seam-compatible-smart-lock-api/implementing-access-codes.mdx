---
title: 'Implementing Access Codes'
description: 'How to create, update, list, and track PIN codes on smart locks through your API.'
---
...
If the request is invalid or the device cannot accept changes, your API should return [an error response](implementing-access-codes#common-error-responses) immediately instead of a pending status.
