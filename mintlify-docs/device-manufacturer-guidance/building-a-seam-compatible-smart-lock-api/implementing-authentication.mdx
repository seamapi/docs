...
description: 'A guide to implementing OAuth2 so Seam can securely connect to your platform and access user devices.'
---
...
After Seam sends the authorization request in [step 1](implementing-authentication#id-1.-authorization-request-launches-the-flow), your service should display a login and consent screen. The user signs in, reviews what Seam will be able to access, and decides whether to continue.

<Columns cols={2}>
<div>
<figure><img src="/images/google sign in copy.png" alt="" width="375" /><figcaption><p>Example login screen from Google</p></figcaption></figure>

</div>

<div>
<figure><img src="/images/image (48).png" alt="" width="375" /><figcaption><p>Example consent screen from Google</p></figcaption></figure>
...
- `state` must match what Seam originally sent in [Step 1](implementing-authentication#id-1.-authorization-request-launches-the-flow).
...
<pre class='language-http'>
  <code class='lang-http'>
    <strong>POST https://api.provider.com/oauth/token</strong>Content-Type:
