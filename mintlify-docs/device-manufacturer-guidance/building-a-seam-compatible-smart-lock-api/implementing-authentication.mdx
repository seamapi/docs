...
<Columns cols={2}>
<div>
<img src="/images/google-sign-in-copy.png" alt="Example login screen from Google" style={{width: "400px", height: "auto"}} />

</div>

<div>
![Example consent screen from Google](/images/image-(48).png)
