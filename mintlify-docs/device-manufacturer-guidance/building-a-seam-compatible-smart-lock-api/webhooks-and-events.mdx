...
description: 'Send real-time device updates to Seam through a single webhook endpoint per environment to keep lock state, access codes, and connectivity accurate.'
---
