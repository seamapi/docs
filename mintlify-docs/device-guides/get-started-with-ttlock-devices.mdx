...
<figure><picture><source srcset="/images/ttlock_get-started-cover_dark.png" media="(prefers-color-scheme: dark)"><img src="/images/ttlock_get-started-cover_light.png" alt="TTLock smart locks"></picture><figcaption><p>TTLock smart locks</p></figcaption></figure>
