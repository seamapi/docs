...
<figure><img src="/images/schlage-getting-started-guide-cover.jpg" alt=""><figcaption><p>Schlage Smart Locks</p></figcaption></figure>
...
<div data-gb-custom-block data-tag="openapi" data-src='/images/openapi.json' data-path='/locks/lock_door' data-method='post'>

[openapi.json](/images/openapi.json)
