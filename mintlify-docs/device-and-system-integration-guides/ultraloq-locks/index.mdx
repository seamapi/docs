...
<Warning>
  **Important:** Ultraloq devices require timezone configuration before you can
  ...
  Timezones](configuring-ultraloq-device-timezones) for details.
</Warning>
...
For complete instructions, see [Configuring Ultraloq Device Timezones](configuring-ultraloq-device-timezones).
...
[→ See: Ultraloq Setup Guide](ultraloq-setup-guide)
