...
- [POST /access_codes/create](/api/access_codes/create)
- [GET /access_codes/get](/api/access_codes/get)
- [GET /access_codes/list](/api/access_codes/list)
- [POST /access_codes/delete](/api/access_codes/delete)
