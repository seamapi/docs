...
<Card title="Configure Device Timezones" href="/configuring-ultraloq-device-timezones">
...
<Card title="Create Access Codes" href="/creating-ultraloq-access-codes">
  Learn how to create permanent and time-bound access codes for Ultraloq locks.
</Card>
