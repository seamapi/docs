...
<figure><img src="/images/lockly-manufacturer-page-cover-16-9-light.png" alt=""><figcaption></figcaption></figure>
...
<CardGroup cols={2}>
<Card title="Connect Lockly to Seam" href="/lockly-setup-guide">
  Follow the setup guide to prepare your Lockly account and enable API access.
</Card>
<Card title="Order Locks" href="https://lockly.com/collections/door-lock" img="/images/lockly-logo.png">
