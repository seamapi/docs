...
[→ See: Lockly Setup Guide](lockly-setup-guide)
...
<CardGroup cols={2}>
  <Card
    title='Connect Lockly to Seam'
    href='/lockly-setup-guide'
  ...
  <Card
    title='Order Locks'
    href='https://lockly.com/collections/door-lock'
