...
<img
  src="https://strapi-media-bucket.fly.storage.tigris.dev/sq_lockly_61e6933e8c.svg"
  alt="Lockly logo"
  width="192"
  height="192"
...
<CardGroup cols={2}>
  <Card
    ...
    href='/device-and-system-integration-guides/lockly-locks/lockly-setup-guide'
