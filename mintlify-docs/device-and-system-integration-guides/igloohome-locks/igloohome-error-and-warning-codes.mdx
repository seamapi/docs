---
title: 'IglooHome Error and Warning Codes'
description: 'This guide covers error and warning codes specific to IglooHome devices integrated through Seam.'
---
...
<Info>
  **Note:** Error and warning codes may change over time as we improve our error
  handling. Use these codes as a reference for troubleshooting, but avoid
  building logic that depends on specific code keys remaining static.
</Info>
...
<Info>
  **Note:** The legacy warning `functional_offline_device` is being migrated to
