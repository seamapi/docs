---
title: 'Dormakaba Ambiance Setup Guide'
description: 'Learn how to configure your Dormakaba Ambiance access control system for integration with Seam.'
---
...
<Info>
  If your Ambiance server is on-premises, [install Seam
  Bridge](https://docs.seam.co/latest/capability-guides/seam-bridge) before
  continuing.\ Seam Bridge provides the secure outbound connection Seam uses to
  reach your Ambiance REST and SOAP APIs.\ Install it on the same computer as
  Ambiance or on a machine with network access to Ambiance and verify it’s
  running.
</Info>
