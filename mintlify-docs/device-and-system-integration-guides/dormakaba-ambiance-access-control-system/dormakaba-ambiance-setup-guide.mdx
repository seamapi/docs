---
title: "Dormakaba Ambiance Setup Instructions"
...
2.  **(Bridge only) Enter your pairing token**\
    ...
    <figure><img src="/images/seam-bridge-client.png" alt=""><figcaption><p>Grab the Pairing Token from the top right corner of the Bridge application.</p></figcaption></figure>
