---
title: 'Get Started with Honeywell Resideo Thermostats'
description: 'Learn how to connect and control Honeywell Resideo thermostats with the Seam API.'
---
...
<Info>
  ...
  you want to connect a real Honeywell Resideo thermostat, use a [non-sandbox
...
Go to [https://console.seam.co/](https://console.seam.co/). On the **Devices** page, click **+ Add Devices**. Then, see [Authorize your workspace](get-started-with-honeywell-thermostats#authorize-your-workspace) in this guide to complete the Connect Webview authorization flow.
...
<Check>
  ...
  Honeywell Resideo account. We provide [virtual
  devices](sandbox-honeywell-thermostats) for each of the brands that we
  support. These sandbox devices and systems enable you to test your app with
  devices from multiple brands without the need to own all the corresponding
  physical devices.
</Check>

Complete the Connect Webview authorization flow by entering the following [Honeywell Resideo sandbox account](sandbox-honeywell-thermostats) credentials:
...
const allHoneywellResideoThermostats = await seam.devices.list({
...
- [ ] [Set the HVAC mode](get-started-with-honeywell-thermostats#set-the-hvac-mode)
- [ ] [Create and schedule climate presets](get-started-with-honeywell-thermostats#create-and-schedule-climate-presets)
- [ ] [Configure a weekly thermostat program](get-started-with-honeywell-thermostats#configure-a-weekly-thermostat-program)
