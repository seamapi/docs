---
title: 'Get Started with SmartThings Hubs + Thermostats'
description: 'Learn how to connect and control SmartThings-connected thermostats with the Seam API.'
---
...
Go to [https://console.seam.co/](https://console.seam.co/). On the **Devices** page, click **+ Add Devices**. Then, see [Authorize your workspace](get-started-with-smartthings-hubs-+-thermostats#authorize-your-workspace) in this guide to complete the Connect Webview authorization flow.
...
- [ ] [Set the HVAC mode](get-started-with-smartthings-hubs-+-thermostats#set-the-hvac-mode)
- [ ] [Create and schedule climate presets](get-started-with-smartthings-hubs-+-thermostats#create-and-schedule-climate-presets)
- [ ] [Configure a weekly thermostat program](get-started-with-smartthings-hubs-+-thermostats#configure-a-weekly-thermostat-program)
