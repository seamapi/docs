...
Navigate to the URL returned by the Webview object. Since you are using a sandbox workspace, complete the login flow by entering the Yale [sandbox test accounts ](/device-and-system-integration-guides/yale-locks/yale-sample-data)credentials below:
