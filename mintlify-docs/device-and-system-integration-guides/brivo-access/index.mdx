...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <a href='https://resources.brivo.com/data-sheets/assa-abloy-wireless-locks-data-sheet'>
          ASSA ABLOY Aperio™
        </a>
      </td>
      <td>
    ...
    <tr>
      <td>
        <a href='https://www.brivo.com/lp/request-consultation'>Z-Wave</a>
      </td>
      <td>
    ...
    <tr>
      <td>
        <a href='https://www.brivo.com/lp/request-consultation'>Salto</a>
      </td>
...
<CardGroup cols={2}>
  <Card
    title='Order Brivo Devices'
    href='https://www.brivo.com/about/contact-us/'
    img='/images/brivo-logo.png'
  >
    Submit a request on the Brivo Contact Us Page
  </Card>
  <Card
    title='Setup your Brivo account'
    href='/device-and-system-integration-guides/brivo-access/brivo-access-setup-guide'
