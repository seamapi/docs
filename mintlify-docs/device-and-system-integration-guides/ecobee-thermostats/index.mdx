...
<DeviceList manufacturers="ecobee" capabilityName="can_hvac_heat,can_hvac_cool,can_hvac_fan,can_program_thermostat_weekly_programs" />
...
For instructions on connecting ecobee thermostats to Seam, see the [ecobee Setup Guide](./ecobee-setup-guide).
