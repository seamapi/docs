---
title: 'Get Started with ecobee Thermostats'
description: 'Learn how to connect and control ecobee thermostats with the Seam API.'
---

<figure><picture><source srcset="/images/ecobee-manufacturer-page-cover-dark.png" media="(prefers-color-scheme: dark)" /><img src="/images/ecobee-manufacturer-page-cover-light.png" alt="" /></picture><figcaption><p>ecobee Thermostats</p></figcaption></figure>
...
<Info>
  ...
  you want to connect a real ecobee thermostat, use a [non-sandbox
...
Go to [https://console.seam.co/](https://console.seam.co/). On the **Devices** page, click **+ Add Devices**. Then, see [Authorize your workspace](get-started-with-ecobee-thermostats#authorize-your-workspace) in this guide to complete the Connect Webview authorization flow.
...
<Check>
  Because you're using a sandbox workspace, you can connect Seam's test ecobee
  account. We provide [virtual devices](ecobee-sample-data) for each of the
...
Complete the Connect Webview authorization flow by entering the following [ecobee sandbox account](ecobee-sample-data) credentials:

- **Email:** jane@example.com
- **Password:** 1234

<figure><picture><source srcset="/images/ecobee_connect-flow-screens_dark.png" media="(prefers-color-scheme: dark)" /><img src="/images/ecobee_connect-flow-screens_light.png" alt="Use the Seam Connect Webview authorization flow to connect an ecobee account with Seam. This flow varies slightly based on the device manufacturer." /></picture><figcaption><p>Use the Seam Connect Webview authorization flow to connect an ecobee account with Seam. This flow varies slightly based on the device manufacturer.</p></figcaption></figure>
...
- [ ] [Set the HVAC mode](get-started-with-ecobee-thermostats#set-the-hvac-mode)
- [ ] [Create and schedule climate presets](get-started-with-ecobee-thermostats#create-and-schedule-climate-presets)
- [ ] [Configure a weekly thermostat program](get-started-with-ecobee-thermostats#configure-a-weekly-thermostat-program)
