...
<picture>
  ...
  <img src="/images/ecobee-manufacturer-page-cover-light.png" alt="" />
</picture>
...
<picture>
  <source srcset="/images/ecobee_connect-flow-screens_dark.png" media="(prefers-color-scheme: dark)" />
  <img src="/images/ecobee_connect-flow-screens_light.png" alt="Use the Seam Connect Webview authorization flow to connect an ecobee account with Seam. This flow varies slightly based on the device manufacturer." />
</picture>
