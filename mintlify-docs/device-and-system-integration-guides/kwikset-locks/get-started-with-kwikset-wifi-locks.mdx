...
<Info>
  ...
  you need to connect a real Kwikset Halo Lock, use a non-sandbox workspace and
  API key.
</Info>
...
> **`POST`** `/locks/lock:door`
>
> See the [API Reference](/api-reference/locks/lock:door) for details.
