---
title: 'Get started with Salto KS Locks'
...
<Warning>
  During the authorization process, Seam adds an admin user to your Salto KS
  site. Do not suspend or remove this Seam Integration admin user.
</Warning>

<figure><picture><source srcset="/images/salto-ks_connect-flow-screens_dark.png" media="(prefers-color-scheme: dark)"><img src="/images/salto-ks_connect-flow-screens_light.png" alt="Seam Connect Webview flow to connect your Salto KS account with Seam" /></picture><figcaption><p>Seam Connect Webview flow to connect your Salto KS account with Seam</p></figcaption></figure>
...
<Warning>
  Note that Salto KS disables this functionality by default and requires a
  special pass-through waiver via Seam. Please contact Seam to configure your IQ
  hubs to enable this functionality.
</Warning>
