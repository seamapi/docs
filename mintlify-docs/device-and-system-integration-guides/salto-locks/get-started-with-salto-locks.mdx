...
<picture>
  <source srcset="/images/salto-ks_connect-flow-screens_dark.png" media="(prefers-color-scheme: dark)" />
  <img src="/images/salto-ks_connect-flow-screens_light.png" alt="Seam Connect Webview flow to connect your Salto KS account with Seam" />
</picture>
