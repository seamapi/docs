...
<figure><picture><source srcset="/images/ttlock_connect-flow-screens_dark.png" media="(prefers-color-scheme: dark)" /><img src="/images/ttlock_connect-flow-screens_light.png" alt="Use the Seam Connect Webview authorization flow to connect a TTLock account with Seam. This flow varies slightly based on the device manufacturer and region." /></picture><figcaption><p>Use the Seam Connect Webview authorization flow to connect a TTLock account with Seam. This flow varies slightly based on the device manufacturer and region.</p></figcaption></figure>
