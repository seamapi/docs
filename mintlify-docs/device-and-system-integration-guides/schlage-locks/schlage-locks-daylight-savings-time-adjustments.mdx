---
title: 'Schlage Locks - Daylight Savings time adjustments'
...
<Info>
  **Note:** Software developers may see an “externally modified” warning on some
  codes — this is expected and indicates that Seam applied the adjustment.
</Info>
