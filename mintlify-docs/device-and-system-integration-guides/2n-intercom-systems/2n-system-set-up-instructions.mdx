...
1. **Open device configuration**
   ...
   *   Click the **three-dot icon** next to your device and choose **Open configuration**.\\
       ...
       <figure><img src="/images/Screenshot 2025-10-31 at 4.56.29 PM.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/images/Screenshot 2025-10-31 at 9.45.19 AM.png" alt=""><figcaption></figcaption></figure>
...
2.  **Enter your Company Admin credentials**
    ...
    * **Note:** Use an account with multi-factor authentication (MFA) turned off. If your main admin account requires MFA, create a separate account without MFA for this connection.
    ...
    <figure><img src="/images/Screenshot 2025-10-31 at 11.36.44 AM.png" alt="" width="411"><figcaption></figcaption></figure>
3.  **Choose which devices to connect**\
    ...
    <figure><img src="/images/Screenshot 2025-10-31 at 5.43.46 PM.png" alt="" width="304"><figcaption></figcaption></figure>
4.  **Authorize device access**\
    ...
    <figure><img src="/images/Screenshot 2025-10-31 at 5.46.00 PM.png" alt="" width="319"><figcaption></figcaption></figure>
