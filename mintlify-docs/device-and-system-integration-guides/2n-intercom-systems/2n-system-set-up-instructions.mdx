...
description: 'Connect your 2N intercoms to Seam by preparing a My2N Company Admin account, adding your devices, and enabling Remote API Access.'
---
...
4. **Authorize device access**\
   For each selected device, enter the **Username** and **Password** you created in the [Enable HTTP API for Each Device](#enable-http-api-for-each-device) section.
