---
title: 'Get started with Minut Sensors'
...
<figure>
  <img src='/images/guides/minut-connect-flow-screens.jpg' alt='' />
  <figcaption>
    <p>Seam Connect Webview flow to connect Minut account with Seam</p>
  </figcaption>
</figure>
