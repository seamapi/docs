...
1. Create an [ACS user](/low-level-apis/access-systems/user-management).
...
2. Assign access permissions to the ACS user by assigning them to one or more [access groups](/low-level-apis/access-systems/user-management/assigning-users-to-access-groups).
   - Each access group is preconfigured with specific entrances and schedules.
3. Create an [ACS credential](/low-level-apis/access-systems/managing-credentials).
