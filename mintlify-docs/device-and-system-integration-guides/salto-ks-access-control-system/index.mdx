...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <a href='https://docs.seam.co/latest/api/acs/users'>
          <code>acs_user</code>
        </a>
      </td>
      <td>
    ...
    <tr>
      <td>
        <a href='https://docs.seam.co/latest/api/acs/access_groups'>
    ...
    <tr>
      <td>
        <a href='https://docs.seam.co/latest/api/acs/entrances'>
    ...
    <tr>
      <td>
        <a href='https://docs.seam.co/latest/api/acs/credentials'>
