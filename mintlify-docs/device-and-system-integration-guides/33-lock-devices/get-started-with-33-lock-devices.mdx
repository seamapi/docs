...
Go to [https://console.seam.co/](https://console.seam.co/). On the **Devices** page, click **+ Add Devices**. Then, see [Authorize your workspace](get-started-with-33-lock-devices#authorize-your-workspace) in this guide to complete the Connect Webview authorization flow.
...
- [ ] [Unlock your lock](get-started-with-33-lock-devices#unlock-your-lock)
- [ ] [Program access codes on your lock](get-started-with-33-lock-devices#program-access-codes-on-your-lock)
