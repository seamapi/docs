...
<img
  src="https://strapi-media-bucket.fly.storage.tigris.dev/sq_controlbyweb_c67fb17fa0.svg"
  alt="ControlByWeb logo"
  width="192"
  height="192"
...
![ControlByWeb Devices](/images/guides/controlbyweb-getting-started-guide-cover.jpg)
...
![Seam Connect Webview flow to connect ControlByWeb account with Seam](/images/guides/controlbyweb-connect-flow-screens.jpg)
