...
<figure><picture><source srcset="/images/4suites_get-started-cover_dark.png" media="(prefers-color-scheme: dark)"><img src="/images/4suites_get-started-cover_light.png" alt="4SUITES smart locks"></picture><figcaption><p>4SUITES smart locks</p></figcaption></figure>
...
<figure><picture><source srcset="/images/4suites_connect-flow-screens_dark.png" media="(prefers-color-scheme: dark)"><img src="/images/4suites_connect-flow-screens_light.png" alt="Use the Seam Connect Webview authorization flow to connect a 4SUITES account with Seam. This flow varies slightly based on the device manufacturer."></picture><figcaption><p>Use the Seam Connect Webview authorization flow to connect a 4SUITES account with Seam. This flow varies slightly based on the device manufacturer.</p></figcaption></figure>
