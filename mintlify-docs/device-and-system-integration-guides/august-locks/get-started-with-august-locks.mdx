...
<picture>
  <source srcset="/images/august_get-started-cover_dark.png" media="(prefers-color-scheme: dark)" />
  <img src="/images/august_get-started-cover_light.png" alt="August smart locks" />
</picture>
...
<picture>
  <source srcset="/images/august_connect-flow-screens_dark.png" media="(prefers-color-scheme: dark)" />
  <img src="/images/august_connect-flow-screens_light.png" alt="Use the Seam Connect Webview authorization flow to connect an August account with Seam. This flow varies slightly based on the device manufacturer and region." />
</picture>
