...
After connecting, Seam needs three pieces of information to finish configuring your account. You can find all of this in the Hotek SMART software.
...
Ensure your Seam workspace is enabled for Hotek access. Contact [Seam support](mailto:support@getseam.com) if the Hotek provider does not appear in your Connect Webview or Console.
