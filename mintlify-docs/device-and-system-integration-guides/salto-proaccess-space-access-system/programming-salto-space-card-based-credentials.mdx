...
1. Create an [access system user](/low-level-apis/access-systems/user-management).
2. Assign access permissions to the user by assigning them to one or more [access groups](/low-level-apis/access-systems/user-management/assigning-users-to-access-groups).
   - Each access group is preconfigured with specific entrances.
3. Create a [credential](/low-level-apis/access-systems/managing-credentials).
...
4. Encode the credential onto a card.
   ...
   Encoders](/low-level-apis/access-systems/working-with-card-encoders-and-scanners/creating-and-encoding-card-based-credentials#id-2.-retrieve-encoders).
   ...
   [Encode the
   Card](/low-level-apis/access-systems/working-with-card-encoders-and-scanners/creating-and-encoding-card-based-credentials#id-3.-encode-the-card).
   3. Confirm that the card was encoded successfully using polling or a
   [webhook](/developer-tools/webhooks).\ See
   [Confirm Successful
   Encoding](/low-level-apis/access-systems/working-with-card-encoders-and-scanners/creating-and-encoding-card-based-credentials#id-4.-confirm-successful-encoding).
   Also, see a list of [common encoding
   errors](/low-level-apis/access-systems/working-with-card-encoders-and-scanners/creating-and-encoding-card-based-credentials#common-encoding-errors).
...
- [Working with Card Encoders and Scanners](/low-level-apis/access-systems/working-with-card-encoders-and-scanners)
