---
title: 'Sandbox Salto Space Access System'
description: 'Add a virtual Salto Space access system to your Seam sandbox workspace using these Seam Bridge and connection credentials to test your integration.'
---
...
<table>
  <thead>
    <tr>
      <th width='311'>System Name</th>
      <th>Transport Type used by the Salto Space Server</th>
      <th width='201.4000244140625'>LAN URL of the Salto Space server</th>
      <th width='101.800048828125'>Username</th>
      <th width='112.39990234375'>Password</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>
        Any string to identify this Salto Space site, for example, My Salto
        Space Site
      </td>
      <td>HTTP</td>
      <td>http://192.168.1.101:8100</td>
      <td>jane</td>
      <td>1234</td>
    </tr>
  </tbody>
