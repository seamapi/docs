...
4. In the **Salto SHIP Server** pane:
   ...
   3.  If you've selected **HTTP(S)**:
       ...
       <figure><img src="/images/salto-space-ship-settings.png" alt="In the Salto Space SHIP settings, specify a username and password for the integration with Seam."><figcaption><p>In the Salto Space SHIP settings, specify a username and password for the integration with Seam.</p></figcaption></figure>
