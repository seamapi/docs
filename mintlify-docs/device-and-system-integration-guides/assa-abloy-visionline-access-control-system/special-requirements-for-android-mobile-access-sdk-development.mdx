---
title: 'Special Requirements for Android Mobile Access SDK Development'
description: 'Learn the requirements and restrictions for developing Android apps that integrate with the Visionline ACS.'
---
