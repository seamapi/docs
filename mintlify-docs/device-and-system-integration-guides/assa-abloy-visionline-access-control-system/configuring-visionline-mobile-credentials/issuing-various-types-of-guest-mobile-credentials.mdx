---
title: 'Issuing Various Types of Guest Mobile Credentials'
...
To issue a credential for a single guest in a single room, create an [override guest credential](/device-and-system-integration-guides/assa-abloy-visionline-access-control-system/configuring-visionline-mobile-credentials#issue-the-first-credential-for-a-reservation).&#x20;
...
To issue credentials for multiple guests in multiple rooms, first create an [override guest credential](/device-and-system-integration-guides/assa-abloy-visionline-access-control-system/configuring-visionline-mobile-credentials#issue-the-first-credential-for-a-reservation). Then, create all subsequent guest credentials as [joiners](/device-and-system-integration-guides/assa-abloy-visionline-access-control-system/configuring-visionline-mobile-credentials#issue-subsequent-credentials-for-a-reservation).
