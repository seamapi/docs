---
title: 'Step 3: Confirm BLE Module on All Locks'
description: 'Learn how to confirm that the BLE module, which is required for mobile keys, is installed on all locks.'
---
...
1. [Install Lock Service 3G on a laptop or tablet.](step-3-confirm-ble-module-on-all-locks#install-lock-service-3g)
2. [Confirm that all locks have the required BLE module.](step-3-confirm-ble-module-on-all-locks#confirm-that-all-locks-have-the-required-ble-module)
