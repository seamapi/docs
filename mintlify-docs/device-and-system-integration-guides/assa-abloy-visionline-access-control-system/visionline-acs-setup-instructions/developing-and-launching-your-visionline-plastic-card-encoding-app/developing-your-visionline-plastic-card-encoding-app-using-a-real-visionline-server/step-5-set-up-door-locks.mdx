---
title: "Step 5: Set up Door Locks"
description: "Learn how to set up door locks when developing your Visionline plastic card encoding integration."
---
...
3.  Define each set of guest room doors.
    ...
    <figure><img src="/images/visionline-add-guest-doors.png" alt="Create a set of guest room doors using the door area that you created."><figcaption><p>Create a set of guest room doors using the door area that you created.</p></figcaption></figure>
...
3.  Define each common door.
    ...
    <figure><img src="/images/visionline-add-common-entrance-door.png" alt="Create one or more common doors using the door area that you created."><figcaption><p>Create one or more common doors using the door area that you created.</p></figcaption></figure>
