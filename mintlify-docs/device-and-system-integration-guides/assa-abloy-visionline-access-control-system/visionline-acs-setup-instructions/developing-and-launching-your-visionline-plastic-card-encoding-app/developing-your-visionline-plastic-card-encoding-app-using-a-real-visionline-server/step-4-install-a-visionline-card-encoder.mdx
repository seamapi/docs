...
2.  Select the encoder that you registered in the previous section and then click **OK**.
    ...
    <figure><img src="/images/visionline-select-encoder-window.png" alt="Select the card encoder that you want to use." width="563"><figcaption><p>Select the card encoder that you want to use.</p></figcaption></figure>
