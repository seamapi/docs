...
```
   ![Specify the details for the new card encoder device.](/images/visionline-card-encoder-device-details-window.png)
```
...
```
   ![Select the correct RFID encoder &#x26; updater.](/images/visionline-card-encoder-select-s-n-field.png)
```
