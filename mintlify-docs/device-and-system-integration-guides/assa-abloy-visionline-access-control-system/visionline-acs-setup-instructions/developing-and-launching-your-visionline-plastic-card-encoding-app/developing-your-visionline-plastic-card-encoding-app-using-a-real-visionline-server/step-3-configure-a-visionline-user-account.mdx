...
4.  Note the username and password for this Visionline user. You must use these credentials when you [connect your Visionline account to Seam](step-8-connect-your-visionline-development-account-to-seam).
