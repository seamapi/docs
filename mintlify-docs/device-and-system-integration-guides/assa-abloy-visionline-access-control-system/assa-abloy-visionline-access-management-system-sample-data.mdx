---
title: 'Sandbox Assa Abloy Visionline Access Control System'
description: 'Add virtual ASSA ABLOY Visionline access control system devices to your Seam sandbox workspace using these sample credentials to test your integration.'
---
...
<Info>
  To use the virtual Vostio Access System to issue mobile keys in a sandbox
  workspace, you must also connect a [virtual ASSA ABLOY Credential
  Services](https://docs.seam.co/latest/device-and-system-integration-guides/assa-abloy-vingcard-credential-services).
</Info>
...
<table>
  <thead>
    <tr>
      <th width='328'>Visionline Site Name</th>
      <th width='282'>Username</th>
      <th width='162'>Password</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>
        Any string to identify this Visionline ACS site, for example, My
        Visionline Site
      </td>
      <td>jane</td>
      <td>1234</td>
