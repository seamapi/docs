...
- [Issuing plastic card credentials](/low-level-apis/access-systems/managing-credentials#create-a-key-card-based-credential)
...
<table data-card-size='large' data-view='cards'>
  ...
  <tbody>
    <tr>
      ...
      <td></td>
      <td>
        <a href='https://www.assaabloyglobalsolutions.com/en/about/local-contacts'>
          https://www.assaabloyglobalsolutions.com/en/about/local-contacts
        </a>
      </td>
      <td>
