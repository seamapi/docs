---
title: 'Sandbox Latch Access Control System'
description: 'Add a virtual Latch access control system to your Seam sandbox workspace using the Seam Console, with no credentials required, to test your integration.'
---
