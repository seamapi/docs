...
Navigate to the URL returned by the Webview object. Since you are using a sandbox workspace, complete the login flow by entering the Wyze [sandbox test account](/device-and-system-integration-guides/wyze-locks/wyze-sample-data)credentials below:
