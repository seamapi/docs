...
![Avigilon Alta access system devices](/images/avigilon-alta-acs-devices.png)
...
3. In the settings for the user, verify the user's permissions as follows:
   ...
   ![Verify user permissions in the Avigilon Alta dashboard.](/images/avigilon-alta-user-permissions.png)
