...
<figure><img src="/images/guides/noiseaware-connect-flow-screens.jpg" alt="" /><figcaption><p>Seam Connect Webview flow to connect NoiseAware account with Seam</p></figcaption></figure>
