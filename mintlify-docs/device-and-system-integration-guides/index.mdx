...
Each brand guide includes sandbox credentials that you can use to connect virtual devices in a [sandbox workspace](/core-concepts/workspaces#sandbox-workspaces), so you can test your integration without owning physical devices.
