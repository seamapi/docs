...
<table data-card-size='large' data-view='cards'>
  ...
  <tbody>
    <tr>
      <td></td>
      <td>
        <a href='https://ptisecurity.my.salesforce-sites.com/apex/Support'>
          <strong>PTI Security Systems Customer Support</strong>
        </a>
      </td>
      <td></td>
      <td>
        <a href='/images/pti-help-center.png'>pti-help-center.png</a>
      </td>
      <td>
        <a href='https://ptisecurity.my.salesforce-sites.com/apex/Support'>
          https://ptisecurity.my.salesforce-sites.com/apex/Support
        </a>
      </td>
    </tr>
  </tbody>
