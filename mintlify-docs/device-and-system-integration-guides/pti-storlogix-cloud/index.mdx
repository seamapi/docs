...
- [**User Management**](/low-level-apis/access-systems/user-management)
  ...
  You can administer individual [users](/low-level-apis/access-systems#what-is-a-user) and add them to [access groups](/low-level-apis/access-systems#what-is-an-access-group) as needed.
...
For PTI Storlogix Cloud, you must add the [users](/low-level-apis/access-systems#what-is-a-user) to `pti_access_level` and `pti_unit` [access groups](/low-level-apis/access-systems#what-is-an-access-group) to give them access to their storage unit.
