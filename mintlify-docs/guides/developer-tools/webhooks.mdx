...
![Click + Add Webhook to create a webhook for your device events.](/images/add-webhook-button.png)

You can specify any public URL endpoint to receive webhook events by pasting the URL into the **Create Webhook** dialog.

<figure><img src="/images/create-webhook-dialog.png" alt="You can specify any internet-accessible URL as your webhook URL." width="563" /><figcaption><p>You can specify any internet-accessible URL as your webhook URL.</p></figcaption></figure>
...
![The Svix sandbox environment enables you to test sending requests to an endpoint.](</images/image (15).png>)

You can view all the event types and the included fields in the **Event Catalog** tab.

![Go to the "Event Catalog" tab to view all available events.](</images/image (27).png>)
...
<figure><img src="/images/testing-your-webhooks.png" alt="Use the webhooks playground to test events." /><figcaption><p>Use the webhooks playground to test events.</p></figcaption></figure>
