...
**See also:** [`SeamCredential.supportedUnlockProximities`](/mobile-sdks/ios/reference/seam-credential), [`Seam.unlock(using:proximity:timeout:)`](/mobile-sdks/ios/reference/seam#unlock-using-proximity-timeout-)
