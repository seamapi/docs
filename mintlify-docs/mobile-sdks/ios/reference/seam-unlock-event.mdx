...
**See also:** [`Seam.unlock(using:proximity:timeout:)`](/mobile-sdks/ios/reference/seam#unlock-using-proximity-timeout-), [`SeamUnlockProximity`](/mobile-sdks/ios/reference/seam-unlock-proximity)
