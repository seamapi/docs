...
<Steps>
  ...
  <Step title="Event Stream">
    The SDK emits `SeamUnlockEvent` values: `launched`, `connected`, `grantedAccess`, and others.
  </Step>
...
| **SeamUnlockEvent** | Enum describing each stage of an unlock operation (`launched`, `connected`, `grantedAccess`, `timedOut`, `connectionFailed`). |
