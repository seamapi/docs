...
For full API documentation and additional examples, see the [Seam iOS SDK reference](https://ios.seam.vc/documentation/seamsdk/seam).
...
<AccordionGroup>
  ...
  <Accordion title="Build errors related to rsync/samba">
    Disable **User Script Sandboxing** in Build Settings as described in the [Configure Xcode Settings](#configure-xcode-settings) step above.
  </Accordion>
