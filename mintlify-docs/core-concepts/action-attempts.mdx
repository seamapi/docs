...
description: 'Learn about action attempts and how they help you to track the progress of asynchronous actions in the physical world.'
---
...
For more information, see [Action Attempts](/api/action_attempts/object) in the Seam API reference.
