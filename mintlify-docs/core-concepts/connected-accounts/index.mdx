...
- An set of editable custom metadata, such as your own internal ID for the user.\
  This custom metadata is useful for [filtering connected accounts](filtering-connected-accounts-by-custom-metadata) using the [List Connected Accounts](https://docs.seam.co/latest/api/connected_accounts/list) method.\
