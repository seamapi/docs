...
<figure><img src="/images/Seam Connect.png" alt="Use Connect Webviews to enable your users to authorize your app to control their devices." /><figcaption></figcaption></figure>
...
<figure><img src="/images/common-workspace-setup (2).png" alt="Most Seam customers use a single production workspace to connect all their devices." /><figcaption></figcaption></figure>
...
<figure><img src="/images/less-common-workspace-setup.png" alt="Some development scenarios may warrant using multiple production workspaces." /><figcaption></figcaption></figure>
