...
<figure>
  <img
    src='/images/workspace-illustration.png'
    alt='Workspaces encapsulate resources, such as devices and connected accounts. An API key for the workspace is required to interact with these resources. You can configure webhook endpoints to receive notifications from devices inside a workspace.'
  />
...
4.  Disable **Sandbox mode**.
    ...
    ![To create a production workspace, disable sandbox mode.](/images/add-production-workspace.png)
...
<figure>
  <img
    src='/images/Seam-Connect.png'
    alt='Use Connect Webviews to enable your users to authorize your app to control their devices.'
  />
  <figcaption></figcaption>
</figure>
...
<figure>
  <img
    src='/images/common-workspace-setup-(2).png'
    alt='Most Seam customers use a single production workspace to connect all their devices.'
  />
  <figcaption></figcaption>
</figure>
...
<figure>
  <img
    src='/images/less-common-workspace-setup.png'
    alt='Some development scenarios may warrant using multiple production workspaces.'
  />
  <figcaption></figcaption>
</figure>
...
<Tab title='Python'>
  ```python # Reset the sandbox workspace associated with your API key.
  seam.workspaces.reset_sandbox() ```

</Tab>

<Tab title='Ruby'>
  ```ruby # Reset the sandbox workspace associated with your API key.
  seam.workspaces.reset_sandbox ```
