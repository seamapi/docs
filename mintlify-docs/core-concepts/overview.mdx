...
4. You use [Seam Console](seam-console/) to manage your Seam workspaces, Connect Webviews, devices, and systems; [create API keys](authentication/api-keys#create-an-api-key); and perform other tasks.
