...
<figure>
  <img
    src='/images/client-session-flow.png'
    alt='Client sessions and client session tokens increase efficiency by enabling your user&#x27;s browser to communicate directly with the Seam backend server.'
  />
