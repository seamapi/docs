---
title: 'Seam Console'
description: 'Use Seam Console to manage your Seam workspaces, Connect Webviews, devices, and systems; generate API keys; use the Seam Online CLI; and perform other tasks.'
---
...
- Create and manage [workspaces](/core-concepts/workspaces/index).
- Create and manage [API keys](../authentication/api-keys).
- Add and manage [devices](/core-concepts/devices/index).
- Add and manage [access control systems](/low-level-apis/access-systems/index).
- Create, customize, and manage [Connect Webviews](/core-concepts/connect-webviews/index).
- Add and manage [webhooks](../../developer-tools/webhooks).
- Use the [Seam Online CLI](/core-concepts/seam-console/seam-online-cli).
