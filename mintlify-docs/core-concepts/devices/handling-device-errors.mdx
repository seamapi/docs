...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Device has been removed from the connected account. Seam can no longer
    ...
    <tr>
      ...
      <td>
        Hub to which the device is connected is offline. Seam is unable to sync
        updates to this device.
      </td>
    </tr>
  </tbody>
</table>
...
<Info>
  If the connected account associated with a device has an error, it is attached
  to the device alongside any other device errors. Treat these errors as
  specific errors.
</Info>
