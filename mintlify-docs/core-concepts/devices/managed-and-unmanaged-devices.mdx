---
title: 'Managed and Unmanaged Devices'
description: 'You can indicate the devices in your workspace that you intend to control using the Seam API.'
---
