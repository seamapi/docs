...
- [Use the `properties.online` property of the `device` object.](displaying-device-health#get-device-status-using-device-properties)
- [Use the `device.connected` and `device.disconnected` events.](displaying-device-health#get-device-status-using-connection-related-events)
...
<Info>
  ...
  [sandbox workspace](../workspaces/#sandbox-workspaces). See [Testing Your App
  Against Device Disconnection and
  Removal](testing-your-app-against-device-disconnection-and-removal).
</Info>
