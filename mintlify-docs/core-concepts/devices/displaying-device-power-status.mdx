...
<figure><img src="/images/seam-component-device-power-status-display-example.png" alt="Display the power status of your end users&#x27; devices in your app."><figcaption></figcaption></figure>
