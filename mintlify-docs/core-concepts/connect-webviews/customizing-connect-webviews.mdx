---
title: 'Customizing Connect Webviews'
description: 'You can customize the look and feel, brand list, and behavior of your Connect Webviews.'
---

You can use [Seam Console](/core-concepts/seam-console/index) to customize the [Connect Webviews](./) that you present to your users through your app.
...
- [Brands (manufacturers) to display](#customize-the-brands-to-display-in-your-connect-webviews)
...
<figure>
  <img
    src='/images/connect-webview-customization.png'
    alt='You can customize the look and feel of Connect Webviews.'
  />
  <figcaption>
    <p>You can customize the look and feel of Connect Webviews.</p>
  </figcaption>
</figure>
...
When you create a Connect Webview, you can customize the providers—that is, the brands—that it displays. In the [Create Connect Webview](/api/connect_webviews/create) request, include the desired set of device provider keys in the `accepted_providers` parameter. Seam supports the following device provider keys:
...
| [ASSA ABLOY Credential Service](/device-and-system-integration-guides/assa-abloy-vingcard-credential-services)                   | `assa_abloy_credential_service` |
...
| [August Home](/device-and-system-integration-guides/august-locks)                                                                | `august`                        |
| [Avigilon Alta](/device-and-system-integration-guides/avigilon-alta-access-system)                                               | `avigilon_alta`                 |
| [Brivo](/device-and-system-integration-guides/brivo-access)                                                                      | `brivo`                         |
| [ControlByWeb](/device-and-system-integration-guides/controlbyweb-relays)                                                        | `controlbyweb`                  |
...
| [ecobee](/device-and-system-integration-guides/ecobee-thermostats)                                                               | `ecobee`                        |
...
| [Kwikset](/device-and-system-integration-guides/kwikset-locks)                                                                   | `kwikset`                       |
...
| [Minut](/device-and-system-integration-guides/minut-sensors)                                                                     | `minut`                         |
| [Nest](/device-and-system-integration-guides/google-nest-thermostats)                                                            | `google_nest`                   |
| [NoiseAware](/device-and-system-integration-guides/noiseaware-sensors)                                                           | `noiseaware`                    |
| [Nuki](/device-and-system-integration-guides/nuki-locks)                                                                         | `nuki`                          |
| [PTI Storlogix Cloud](/device-and-system-integration-guides/pti-storlogix-cloud)                                                 | `pti`                           |
| [Salto KS Access System](/device-and-system-integration-guides/salto-ks-access-control-system)                                   | `salto_ks`                      |
| [Salto KS Locks](/device-and-system-integration-guides/salto-locks)                                                              | `salto_ks`                      |
...
| [SmartThings](/device-and-system-integration-guides/smartthings-hubs-+-devices/get-started-with-smartthings-hubs-+-smart-locks)  | `smartthings`                   |
| [Tedee](/device-and-system-integration-guides/tedee-locks)                                                                       | `tedee`                         |
| [TTLock](/device-and-system-integration-guides/ttlock-locks)                                                                     | `ttlock`                        |
| [Wyze](/device-and-system-integration-guides/wyze-locks)                                                                         | `wyze`                          |
| [Yale](/device-and-system-integration-guides/yale-locks)                                                                         | `yale`                          |

To help you decide which providers to include in a Connect Webview, you can use the [List Device Providers](/api/devices/list_device_providers) method to learn about each provider. The information that this method returns for each provider includes a set of [capability flags](../../capability-guides/device-and-system-capabilities#capability-flags), such as `device_provider.can_remotely_unlock`. If at least one supported device from a provider has a specific capability, the corresponding capability flag is `true`.

<Info>
  If you omit the `accepted_providers` parameter, the Connect Webview displays
  ...
  Webview](/core-concepts/connect-webviews/connect-webview-process#step-1-create-a-connect-webview).
</Info>
