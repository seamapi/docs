---
title: 'Attaching Custom Metadata to the Connect Webview'
description: 'Use custom metadata to link internal IDs from your application to a Seam Connect Webview and connected account.'
---
...
Once you have attached custom metadata to Connect Webviews, you can [filter your Connect Webviews](filtering-connect-webviews-by-custom-metadata) by this custom metadata.
