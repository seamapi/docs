---
title: 'Connect Webview Process'
description: 'Learn how to create, display, and complete Connect Webviews to connect devices and systems to Seam.'
---
...
- To display a specific, custom set of providers, specify the desired list of `accepted_providers`. For details, see [Customize the Brands to Display in Your Connect Webviews](/core-concepts/connect-webviews/customizing-connect-webviews#customize-the-brands-to-display-in-your-connect-webviews).
...
In your app, [open the Connect Webview for your user](/core-concepts/connect-webviews/embedding-a-connect-webview-in-your-app#step-1-open-a-connect-webview), using the Connect Webview `url`.

You can [redirect to the Connect Webview URL](/core-concepts/connect-webviews/embedding-a-connect-webview-in-your-app#redirect-to-the-connect-webview-url) or [embed the Connect Webview in an iframe](/core-concepts/connect-webviews/embedding-a-connect-webview-in-your-app#embed-the-connect-webview-in-an-iframe).

<Info>
  If you choose to embed a Connect Webview in an iframe, it's important to
  understand that some providers move to a new tab during their authentication
  flow for security purposes. Seam is not able to abstract away this behavior.
</Info>

For instructions, see [Embedding a Connect Webview in Your App](/core-concepts/connect-webviews/embedding-a-connect-webview-in-your-app).
...
<figure>
  <img
    src='/images/connect-webview-intro-screen.png'
    alt='Connect Webview introduction page'
    width='563'
  />
...
<figure>
  <img
    src='/images/connect-webview-brand-selection.png'
    alt='In the Connect Webview, the user selects their device or ACS brand.'
    width='563'
  />
  <figcaption></figcaption>
</figure>
...
<figure>
  <img
    src='/images/connect-webview-brand-authorization.png'
    alt='In the Connect Webview, the user follows the displayed instructions to authorize the connection to Seam.'
    width='563'
  />
  <figcaption></figcaption>
</figure>
...
<figure>
  <img
    src='/images/connect-webview-success.png'
    alt='The Connect Webview displays a page to indicate the successful device or ACS account connection.'
    width='563'
  />
  <figcaption></figcaption>
</figure>
...
- [Polling](/core-concepts/connect-webviews/verifying-successful-account-connection#polling)
- [Webhook](/core-concepts/connect-webviews/verifying-successful-account-connection#webhook)
- [Event listening](/core-concepts/connect-webviews/verifying-successful-account-connection#event-listening) (for iframes)

For instructions, see [Verifying Successful Account Connection](/core-concepts/connect-webviews/verifying-successful-account-connection).

<Info>
  You do not need to delete a Connect Webview once a user completes it. Instead,
  you can simply ignore completed Connect Webviews.
</Info>
...
For instructions, see [Retrieving Devices or Access Control Systems Connected Through a Connect Webview](/core-concepts/connect-webviews/retrieving-devices-or-access-control-systems-connected-through-a-connect-webview).

<Info>
  If your user wants to connect additional devices or ACS from different brands
  to Seam, your app must create and present a new Connect Webview for each
  different account that your user wants to connect.
</Info>
...
To learn about the actions that you can perform using the Seam API, see the Seam [capability guides](../../capability-guides/device-and-system-capabilities). These guides provide helpful tutorials and code samples, categorized by capability types.

- [Smart locks](/low-level-apis/smart-locks/index), including [locking/unlocking](../../low-level-apis/smart-locks/lock-and-unlock) and [managing access codes](/low-level-apis/smart-locks/access-codes/index)
