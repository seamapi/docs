...
- To display a specific, custom set of providers, specify the desired list of `accepted_providers`. For details, see [Customize the Brands to Display in Your Connect Webviews](customizing-connect-webviews#customize-the-brands-to-display-in-your-connect-webviews).
...
In your app, [open the Connect Webview for your user](embedding-a-connect-webview-in-your-app#opening-a-connect-webview), using the Connect Webview `url`.

You can [redirect to the Connect Webview URL](embedding-a-connect-webview-in-your-app#redirect-to-the-connect-webview-url) or [embed the Connect Webview in an iframe](embedding-a-connect-webview-in-your-app#embed-the-connect-webview-in-an-iframe).
...
For instructions, see [Embedding a Connect Webview in Your App](embedding-a-connect-webview-in-your-app).
...
- [Polling](verifying-successful-account-connection#polling)
- [Webhook](verifying-successful-account-connection#webhook)
- [Event listening](verifying-successful-account-connection#event-listening) (for iframes)

For instructions, see [Verifying Successful Account Connection](verifying-successful-account-connection).
...
For instructions, see [Retrieving Devices or Access Control Systems Connected Through a Connect Webview](retrieving-devices-or-access-control-systems-connected-through-a-connect-webview).
...
- [Smart locks](../../capability-guides/smart-locks/), including [locking/unlocking](../../capability-guides/smart-locks/lock-and-unlock) and [managing access codes](../../capability-guides/smart-locks/access-codes/)
