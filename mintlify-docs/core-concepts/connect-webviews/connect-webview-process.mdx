...
<figure><img src="/images/connect-webview-intro-screen.png" alt="Connect Webview introduction page" width="563" /><figcaption></figcaption></figure>

2. The user selects their device or ACS brand.

<figure><img src="/images/connect-webview-brand-selection.png" alt="In the Connect Webview, the user selects their device or ACS brand." width="563" /><figcaption></figcaption></figure>
...
<figure><img src="/images/connect-webview-brand-authorization.png" alt="In the Connect Webview, the user follows the displayed instructions to authorize the connection to Seam." width="563" /><figcaption></figcaption></figure>
...
<figure><img src="/images/connect-webview-success.png" alt="The Connect Webview displays a page to indicate the successful device or ACS account connection." width="563" /><figcaption></figcaption></figure>
