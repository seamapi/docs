...
![Connect Webview introduction page](/images/connect-webview-intro-screen.png)

2. The user selects their device or ACS brand.

![In the Connect Webview, the user selects their device or ACS brand.](/images/connect-webview-brand-selection.png)
...
![In the Connect Webview, the user follows the displayed instructions to authorize the connection to Seam.](/images/connect-webview-brand-authorization.png)
...
![The Connect Webview displays a page to indicate the successful device or ACS account connection.](/images/connect-webview-success.png)
