...
![Seam makes it easy for your users to authorize your app to control their devices using the Seam API.](/images/connect-webview-embedding-2.png)
...
![Add a button to your app to enable your users to connect their devices or
      ACS using a Connect Webview.](/images/connect-webview-embedding-1-(1).png)
...
2. Redirect your app to the URL for the created Connect Webview.\
   ...
   ![The page to which you redirect your app displays the authorization flow.](/images/connect-webview-user-flow.png)
