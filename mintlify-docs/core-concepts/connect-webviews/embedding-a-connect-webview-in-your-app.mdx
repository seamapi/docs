...
To enable your users to connect their devices or access control system to Seam through your app, use a [Connect Webview](./). First, in your app, add a mechanism—such as a button—to [open a new Connect Webview](embedding-a-connect-webview-in-your-app#step-1-open-a-connect-webview). Then, you can use either of the following two methods to [display the Connect Webview](embedding-a-connect-webview-in-your-app#step-2-display-the-connect-webview) in your app:

- [Redirect to the Connect Webview URL.](embedding-a-connect-webview-in-your-app#redirect-to-the-connect-webview-url)
- [Embed the Connect Webview in an inline frame (iframe).](embedding-a-connect-webview-in-your-app#embed-the-connect-webview-in-an-iframe)
...
When your user clicks this button, your app can either [redirect to the Connect Webview URL](embedding-a-connect-webview-in-your-app#redirect-to-the-connect-webview-url) or [embed the Connect Webview in an iframe](embedding-a-connect-webview-in-your-app#embed-the-connect-webview-in-an-iframe) and present it in a modal.
...
You can [redirect to the Connect Webview URL](embedding-a-connect-webview-in-your-app#redirect-to-the-connect-webview-url) or [use an iframe](embedding-a-connect-webview-in-your-app#embed-the-connect-webview-in-an-iframe) to display the Connect Webview. The following sections describe these two options:
