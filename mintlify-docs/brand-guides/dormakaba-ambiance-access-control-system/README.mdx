...
<CardGroup cols={2}>
<Card title="Connect your Dormakaba Ambiance system to Seam" href="/dormakaba-ambiance-setup-guide" img="/images/image (29).png">
  Follow the setup guide to prepare your Dormakaba Ambiance system and enable API access.
</Card>
<Card title="Order Ambiance Locks" href="https://www.dormakaba.com/us-en/certified-installers" img="/images/ambiance.png">
