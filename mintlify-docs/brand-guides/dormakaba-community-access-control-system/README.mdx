...
<CardGroup cols={2}>
<Card title="Connect your Dormakaba Community system to Seam" href="/dormakaba-community-setup-guide" img="/images/image (29).png">
  Follow the setup guide to prepare your Dormakaba Community system and enable API access.
</Card>
<Card title="Certified Installers Page" href="https://www.dormakaba.com/us-en/certified-installers" img="/images/Screenshot 2025-09-28 at 5.44.01 PM.png">
