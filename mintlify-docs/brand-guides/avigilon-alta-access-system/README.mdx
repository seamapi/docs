...
<figure><img src="/images/avigilon-alta-acs-devices.png" alt="Avigilon Alta access system devices" /><figcaption></figcaption></figure>
...
3.  In the settings for the user, verify the user's permissions as follows:
    ...
    <figure><img src="/images/avigilon-alta-user-permissions.png" alt="Verify user permissions in the Avigilon Alta dashboard." /><figcaption></figcaption></figure>
