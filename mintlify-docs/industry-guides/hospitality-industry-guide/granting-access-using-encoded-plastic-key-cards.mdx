...
![Encode the access method onto a plastic key card.](/images/encode-card-anim-border-added.gif)
...
![Use the Seam API to scan a plastic card to view its details.](/images/scan-card-results.png)
