...
<img src="/images/encode-card-anim-border-added.gif" alt="Encode the access method onto a plastic key card." style={{width: "450px", height: "auto"}} />
...
<img src="/images/scan-card-results.png" alt="Use the Seam API to scan a plastic card to view its details." style={{width: "550px", height: "auto"}} />
