...
<figure><img src="/images/encode-card-anim-border-added.gif" alt="Encode the access method onto a plastic key card." width="563"><figcaption><p>Encode the access method onto a plastic key card.</p></figcaption></figure>
...
<figure><img src="/images/scan-card-results.png" alt="Use the Seam API to scan a plastic card to view its details."><figcaption><p>Use the Seam API to scan a plastic card to view its details.</p></figcaption></figure>
