...
description: 'Issue plastic key cards to hotel guests with Seam by creating a user identity and Access Grant, then encoding the access method onto a card.'
---
...
3. [Encode the Card](#encode-the-card)
4. [Scan the Card](#scan-the-card)
