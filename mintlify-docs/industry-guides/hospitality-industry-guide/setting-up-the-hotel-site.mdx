---
title: 'Setting Up the Hotel Site'
description: 'Set up your hotel access system and integrate it with your Seam-powered PMS app by confirming capabilities, connecting the site, and configuring access.'
---
...
1. [Confirm access system capabilities and requirements.](#access-system-capabilities-and-requirements)
2. [Configure the access system to integrate with Seam.](#access-system-settings)
3. [Connect the hotel site to Seam.](#access-system-seam-connection)
4. [Configure the desired access settings for the hotel's guest rooms.](#guest-room-access-settings)
...
To connect the access system to Seam, we recommend embedding a [Connect Webview](/core-concepts/connect-webviews/index) in your app. The Seam Connect Webview flow guides the property manager through each step of the connection process.

<figure>
  <img
    src='/images/connect-saltoks.png'
    alt='Example Connect Webview for an access system'
  />
  <figcaption>
    <p>Example Connect Webview for an access system</p>
  </figcaption>
</figure>
...
<figure>
  <img
    src='/images/seam-bridge-client.png'
    alt='Use Seam Bridge to connect on-premises access systems to Seam.'
  />
  <figcaption>
    <p>Use Seam Bridge to connect on-premises access systems to Seam.</p>
  </figcaption>
</figure>
...
<div align='center' data-full-width='false'>
  <figure>
    <img src='/images/Map-room-to-common-rooms2.gif' alt='' width='563' />
    <figcaption>
      <p>
        Example: Dashboard for mapping a hotel room listing to the corresponding
