...
![Example Connect Webview for an access system](/images/connect-saltoks.png)
...
![Use Seam Bridge to connect on-premises access systems to Seam.](/images/seam-bridge-client.png)
