...
<img src="/images/connect-saltoks.png" alt="Example Connect Webview for an access system" style={{width: "550px", height: "auto"}} />
...
<img src="/images/seam-bridge-client.png" alt="Use Seam Bridge to connect on-premises access systems to Seam." style={{width: "500px", height: "auto"}} />
...
<div align='center' data-full-width='false'>
  ![Example: Dashboard for mapping a hotel room listing to the corresponding
        set of access points](/images/Map-room-to-common-rooms2.gif)
</div>
