...
<figure><img src="/images/connect-saltoks.png" alt="Example Connect Webview for an access system" /><figcaption><p>Example Connect Webview for an access system</p></figcaption></figure>
...
<figure><img src="/images/seam-bridge-client.png" alt="Use Seam Bridge to connect on-premises access systems to Seam." /><figcaption><p>Use Seam Bridge to connect on-premises access systems to Seam.</p></figcaption></figure>
...
<div align="center" data-full-width="false"><figure><img src="/images/Map room to common rooms2.gif" alt="" width="563" /><figcaption><p>Example: Dashboard for mapping a hotel room listing to the corresponding set of access points</p></figcaption></figure></div>
