---
title: 'Granting Access Using Mobile Keys'
---
...
<Info>
  ...
  Keys](granting-access-using-mobile-keys#granting-access-using-seam-instant-keys)
...
1. [Create a User Identity](granting-access-using-mobile-keys#create-a-user-identity)
2. [Create an Access Grant](granting-access-using-mobile-keys#create-an-access-grant)
3. [Deliver the Mobile Key](granting-access-using-mobile-keys#deliver-the-mobile-key)
...
<figure>
  <img
    src='/images/mobile-key-flow.png'
    alt='Develop a mobile app to deliver the mobile key to your user and to unlock the door.'
  />
  <figcaption>
    <p>
...
<Info>
  ...
  download, use [Seam Instant Keys](granting-access-using-seam-instant-keys).
</Info>
