...
<Info>
  ...
  Keys](granting-access-using-mobile-keys.md#granting-access-using-seam-instant-keys)
...
<Info>
  ...
  download, use [Seam Instant Keys](granting-access-using-seam-instant-keys.md).
</Info>
