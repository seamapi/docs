...
![Send hotel guests Seam Instant Keys in a text message or email—No app
      download required!](/images/iphone-appclip-unlock.png)
...
![You can deliver an Instant Key using a link in a text message or email.](/images/instant-key-text-message.png)
