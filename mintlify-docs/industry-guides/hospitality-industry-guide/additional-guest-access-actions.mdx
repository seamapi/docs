...
- [Sharing access with additional guests on the same reservation](additional-guest-access-actions#sharing-access)
- [Multi-unit access](additional-guest-access-actions#multi-unit-access)
- [Mid-stay room changes](additional-guest-access-actions#room-changes)
- [Early check in/late check out](additional-guest-access-actions#early-check-in-late-check-out)
- [Lost cards](additional-guest-access-actions#lost-cards)
- [Check out](additional-guest-access-actions#check-out)
