---
title: 'Seam API Overview'
description: "Grant and manage guest access across all supported hotel access systems with Seam's unified API and the powerful Access Grants endpoint."
---
...
If you want the easiest, most efficient way to grant access, use the [Access Grants](../../use-cases/granting-access/index) API. This powerful API enables you to grant hotel guests access with a single call—for any access method. With this single API, you can…
...
If you need more granular control, the Seam API provides lower-level API resources and endpoints as well. In this case, use the Seam [access control system](/low-level-apis/access-systems/index) (ACS) API.
...
For details, see [Mapping Your Resources to Seam Resources](../../core-concepts/mapping-your-resources-to-seam-resources).
